      ...
      ?>
        <div class="row">
          ...
          <div class="col-xl-12">
            <div class="card">
              <div class="card-body">
                <p class="text-title">Perincian Penjualan B2B - OLN <?= date("F", strtotime("2023-" . $month_filter . "-01")); ?> <?= $year_filter ?></p>
                <hr>
        ...
        <div class="row">
          <div class="col-xl-12">
            <div class="card ">
              <div class="card-body">
                <p class="text-title">Perbandingan Penjualan B2B - OLN <?= $year_filter ?></p>
                <hr>
        ...
        <div class="row">
          <div class="col-xl-12">
            <div class="card ">
              <div class="card-body">
                <p class="text-title">Penjualan Netto Tahun <?= $year_filter ?></p>
                <hr>
...
<script>
  ...
  $this_b2b = 0;
  $i = 0;
  while ($row_b2b = mysql_fetch_array($sqlb2b_total)) {
    $total_b2b += $row_b2b['sum_totalfaktur'];
    if (($i + 1) == trim($month_filter)) {
      $this_b2b = $row_b2b['sum_totalfaktur'];
    }
    $i++;
  }
  ...
  $this_olnso = 0;
  $i = 0;
  while ($row_olnso = mysql_fetch_array($sqlolnso_total)) {
    $total_olnso += $row_olnso['sum_totalolnso'];
    if (($i + 1) == trim($month_filter)) {
      $this_olnso = $row_olnso['sum_totalolnso'];
    }
    $i++;
  }
  ?>
