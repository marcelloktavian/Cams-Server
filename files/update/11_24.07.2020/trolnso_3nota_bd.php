...
<!-- table 1---->
 ...
 while($m1=mysql_fetch_array($sql1)) {
  ...
  <table width="100%" border="0" class="cut-off "  align="center" cellpadding="0" cellspacing="0">
		  ...
		  <th colspan="6" class="style11btlr"><div align="left">Pengirim : <?=$m1['dropshipper'];?></div></th>
          <!--<td >&nbsp;</td>-->		  
          <th rowspan="1" colspan="2" class="style11btr"><div align="center">(<?=$m1['id_kirim'];?>)<?=$m1['id_trans'];?>/<?=$m1['ref_kode'];?></div></th> 
          </tr> 
		  <!-- 2 -->
		  <tr> 
		  <th colspan="6" class="style11btlr"><div align="left">Penerima :<?=$m1['nama'];?>/<?=$m1['telp'];?><br><? echo "".$m1['alamat']." ".$m1['kecamatan']." ".$m1['kabupaten']." ".$m1['provinsi'];?></div></th>
          <th colspan="2" class="style11btr_barcode"><div align="center" class="style_barcode"><?=$m1['id_trans'];?></div></th> 
          </tr>
    ...
    <tr>
		  ...
		  <td rowspan="1" class="style11btl_kirim" colspan="2" style="color: <?=$m1['kode_warna'];?>;font-weight: bold; border-style: solid; border-color: <?=$m1['kode_warna'];?>;"><div class="style_barcode" align="center" ><?=$m1['exp_code'];?></div></td>
          
	</tr>
	<tr>
		  <td colspan="2" class="style11btrb" ><div align="left">Ongkir=<?=$m1['exp_fee'];?></div></td>	
		  <td colspan="2" class="style11btb" style="color: <?=$m1['kode_warna'];?>;font-weight: bold; border-style: solid; border-color: <?=$m1['kode_warna'];?>;"><div align="center"><?=$m1['exp_code'];?></div></td>	
	</tr>
	<tr>
		<td>&nbsp;</td>		
    </tr>
