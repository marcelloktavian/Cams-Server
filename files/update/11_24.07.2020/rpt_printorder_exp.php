...
<form id="form2" name="form2" action="" method="post"  onSubmit="return validasi(this)">
  ...
  <?
	...
	$sql_exp = "SELECT e.`nama`,e.kode_warna,COUNT(so.id_expedition) AS totalexp FROM olnso so LEFT JOIN mst_expedition e ON so.id_expedition=e.id WHERE e.deleted=0 $filter_title GROUP BY so.id_expedition ";
