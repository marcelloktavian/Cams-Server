...
?>
<table id="table_jual_unservice"></table>
<div id="pager_table_jual_unservice"></div>
<div class="btn_box">
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $("#table_jual_unservice").jqGrid({
            ...
            rowNum:20,
            rowList:[10,20,30],
            pager: '#pager_table_jual_unservice',
            sortname: 'id_trans',
            autowidth: true,
            height: '400',
            viewrecords: true,
        ...
        $("#table_jual_unservice").jqGrid('navGrid','#pager_table_jual_unservice',{edit:false,add:false,del:false});
    })
</script>