...
<?php
	if(isset($_GET['action']) && strtolower($_GET['action']) == 'json') {
		...
		//MENAMPILKAN PENJUALAN YANG BARU INPUT STATE=0 DAN TOTALQTY<>0 KRN BUKAN TRANSAKSI CANCEL
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $("#table_jual").jqGrid({
            ...
            colNames:['ID','ID_web','Dropshipper','Date','Receiver','Address','Qty','Posting','Cancel'],
            colModel:[
