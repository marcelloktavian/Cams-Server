...
<!-- table 1---->
 ...
 while($m1=mysql_fetch_array($sql1)) {
  ...
  <table width="100%" border="0" class="cut-off "  align="center" cellpadding="0" cellspacing="0">
          ...
          <!--<td >&nbsp;</td>-->		  
          <th rowspan="1" colspan="2" class="style11btlr_detail"><div align="center">(<?=$m1['id_kirim'];?>)<?=$m1['id_trans'];?>/<?=$m1['ref_kode'];?></div></th> 
          </tr> 
		  <!-- 2 -->
		  <tr> 
		  <th colspan="6" class="style11btl"><div align="left">Penerima :<?=$m1['nama'];?>/<?=$m1['telp'];?><br><? echo "".$m1['alamat']." ".$m1['kecamatan']." ".$m1['kabupaten']." ".$m1['provinsi'];?></div></th>
