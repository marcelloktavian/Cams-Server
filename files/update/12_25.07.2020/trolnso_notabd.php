...
<form id="form2" name="form2" action="" method="post"  onSubmit="return validasi(this)">
  <table width="100%" border="0"   align="center" cellpadding="0" cellspacing="0">
		  ...
		  <th colspan="6" class="style11btl"><div align="left">Pengirim : <?=$rs['dropshipper'];?></div></th>
          <!--<td >&nbsp;</td>-->		  
          <th rowspan="1" colspan="2" class="style11btlr_detail"><div align="center">(<?=$rs['id_kirim'];?>)<?=$rs['id_trans'];?>/<?=$rs['ref_kode'];?></div></th> 
          </tr> 
		  <!-- 2 -->
		  
		  <tr>
           		  
		  <th colspan="6" class="style11btl"><div align="left">Penerima :<?=$rs['nama'];?>/<?=$rs['telp'];?><br><? echo "".$rs['alamat']." ".$rs['kecamatan']." ".$rs['kabupaten']." ".$rs['provinsi'];?></div></th>
          <th colspan="2" class="style11btlr_detail"><div align="center" class="style_barcode">*<?=$rs['id_trans'];?>*</div></th> 
  ...
  ?>
    ...
    <tr>
		  <td width="50%" class="style11btblr_note" rowspan="2" colspan="4"><div align="left">&nbsp;&nbsp;Note(<?=$rs['exp'];?>)&nbsp;=<?=$rs['note'];?></div></td>
		  ...
		  <td rowspan="1" class="style11btl_kirim" colspan="4" style="color: <?=$rs['kode_warna'];?>;font-weight: bold; border-style: solid; border-color: <?=$rs['kode_warna'];?>;"><div class="style_barcode" align="center" >*<?=$rs['exp_code'];?>*</div></td>
          		  
          		  
	</tr>
	<tr>
		<td colspan="2" class="style11btrb" ><div align="left">Ongkir=<?=$rs['exp_fee'];?></div></td>	
		<td colspan="4" class="style11btb" style="color: <?=$rs['kode_warna'];?>;font-weight: bold; border-style: solid; border-color: <?=$rs['kode_warna'];?>;"><div align="center"><?=$rs['exp_code'];?></div></td>	
