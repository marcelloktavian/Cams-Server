...
<html>
    <head>
		...
		<link rel="stylesheet" href="assets/select2-master/dist/css/select2.min.css"  media="screen">
    </head>
    <body>
    	...
    	<script type="text/javascript" src="assets/select2-master/dist/js/select2.min.js"></script>
		...
		function popup_lihat(url, grid,title,act){
			if(title === undefined || title == '') {
				title = '&nbsp;';
			}
			if(act === undefined || act == '') {
