...
echo"<form id='form2' name='form2' action='' method='post' onSubmit='return validasi_input(this)'>
    <table width='100%'>
  	<tr>
    	<td  class='fontjudul'>DETAIL PENJUALAN</td>
...
<td><input type='text' class='inputform' name='tunai' id='tunai' style='text-align:right;' onkeydown='return numbersonly(this, event);'onkeyup='javascript:tandaPemisahTitik(this);hitungpiutang();' ></td>
<td class='fonttext' >Kartu</td>
<td><input type='text' class='inputform' name='kartu' id='kartu' style='text-align:right;' onchange='calc();'></td>

</tr>
<tr>
<td class='fonttext'>Ongkir</td>
<td><input type='text' class='inputform' name='ongkir' id='ongkir' style='text-align:right;'></td>
...
<tr>
<td>KodeBarang <textarea name='tabrg' id='tabrg' cols='31' rows='2' ></textarea></td>
</tr>
</table>
<hr/>
</form>
...
function calc(){
faktur=parseInt(document.getElementById("faktur").value);
tunai=parseInt(document.getElementById("tunai").value);
document.getElementById("deposit").value = faktur-tunai;	
alert ("testing");	
/*	
          one = document.autoSumForm.val1.value;
          two = document.autoSumForm.val2.value;
          three = document.autoSumForm.val3.value;
          
          document.autoSumForm.val4.value = (one * two) - three;
*/          
}  	
...
function addNewRow1() 
{
var inputkode=document.getElementById("tabrg").value;
//console.log(inputkode.split(' '));
alert ("Testing"+inputkode.split(';'))
...
{   
	...
	//document.getElementById("faktur").value = numbersonly(total);	
	//sisa= total-tunai;
	document.getElementById("faktur").value = total;	
    document.getElementById("tunai").value = total;	
    //document.getElementById("ongkir").value = sisa;	
