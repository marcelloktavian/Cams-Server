...
if (isset($_GET['list_barcode'])){
	...
	$jenis = '';
	$sql = mysql_query("Select sb.id_barang,b.nm_barang,b.hrg_jual,sb.stok,b.kode_brg from barang b left join stok_barang sb  on sb.id_barang = b.id_barang AND sb.tgl_trans = (SELECT MAX(tgl_trans)
FROM stok_barang WHERE id_barang = sb.id_barang) where b.kode_brg IN (".$list_id.") ".$jenis);
	$result = array();
