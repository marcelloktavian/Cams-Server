...
if (isset($_GET['list_barcode'])){
	...
	//'".str_replace(",", "','", $_GET[stringlist])."'
	$sql = mysql_query("Select b.id_barang,b.nm_barang,b.hrg_jual,b.kode_brg from barang b where b.kode_brg IN ('".str_replace
	(",", "','", $list_id)."') ".$jenis);
//	var_dump("Selectzb.id_barang,b.nm_barang,b.hrg_jual,b.kode_brg from barang b where b.kode_brg IN ('".str_replace(",", "','", $list_id)."') ".$jenis);
	$result = array();
