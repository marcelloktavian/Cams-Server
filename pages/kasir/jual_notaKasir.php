...
error_reporting(0);
	...
	$sql_jual="SELECT a.*,a.deposit as depositjual,b.* FROM trjual a 
...
<form id="form2" name="form2" action="" method="post"  onSubmit="return validasi(this)">
  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr>
      <td height="123" valign="top"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td width="50%" class="style99" colspan="3"><strong>INVOICE</strong></td>
            <td class="style9" width="19%">No.Invoice</td>
            <td class="style9" width="1%"><div align="center">:</div></td>
            <td class="style9" width="30%"><?=$rs['kode'];?></td>
          ...
          <tr>
            ...
            <td class="style9" width="1%"><div align="center">:</div></td>
            <td class="style9" width="35%"><?=$rs['alamat'];?></td>           			
          </tr>
          <tr>
  ...
  ?>
	...
	$simpan_deposit_vw=$rs['simpan_deposit'];
	$byr_deposit=$rs['depositjual'];
	$tunai_vw=$rs['tunai'];
	$transfer_vw=$rs['transfer'];
	$ongkos_vw=$rs['biaya'];
	$totqty+=$rs2['kuantum'];
	$total_vw=$total2+$ongkos_vw;
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td width="40%">
	    <div id="keterangan" align="left" class="style20">
		<?=$rs['keluhan'];?>
		</div>
	  </td>
      <td width="5%">&nbsp;</td>
      ...
      <td width="2%">&nbsp;</td> 
      <td width="5%">&nbsp;</td> 
      <td width="10%" class="style9" align="right"><strong>Ongkos Kuli</strong></td>
      <td width="10%">
		<div id="ongkos" align="right" class="style20">
		<? echo number_format($ongkos_vw,0);?>
		</div>
	  </td>	 
    </tr>
	<tr>
      ...
      <td width="5%">&nbsp;</td>
      <td width="5%"><div align="left" class="style9">Total Qty</div></td>
      <td width="5%" class="style9">
	  <div id="jmljasa">
	 ...
	 <td width="5%">&nbsp;</td> 
     <td width="10%" class="style20" align="right"><strong>Grand Total</strong></td>
     <td width="10%">
		<div id="total" align="right" class="style20">
		<? echo number_format($total_vw,0);?>
		</div>
	 </td>	 
    </tr>
	<tr>
	...
	<tr>
      ...
      <td width="1%">&nbsp;</td>
      <td width="4%">&nbsp;</td>
      <td width="11%" class="style9" align="right"><strong>Simpan Deposit</strong></td> 
      <td width="4%">
	    <div id="byrdeposit" align="right" class="style20">
		<? echo number_format($simpan_deposit_vw,0);?>
		</div>
	  </td> 
	...
	<tr>
      ...
      <td width="1%">&nbsp;</td>
      <td width="4%">&nbsp;</td>
      <td width="11%" class="style9" align="right"><strong>Sisa Saldo</strong></td> 
      <td width="4%">
	    <div id="total" align="right" class="style20">
		<? echo number_format($piutang_vw,0);?>
		</div>
	  </td>
	  <td width="10%" class="style9" align="right">
	  <strong>Deposit</strong></td>
	  <td width="10%">
		<div id="total" align="right" class="style20">
		<? echo number_format($byr_deposit,0);?>
		</div>
	  </td>	 
    </tr>
