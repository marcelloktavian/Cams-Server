...
//include("koneksi/koneksi.php");
	...
	mysql_query("insert into trjual(id_trans,kode,tgl_trans,id_customer,biaya,faktur,totalfaktur,tunai,transfer,kartu,piutang,totalqty,keluhan,id_user)values('".$id_pkb."','".$kode."',NOW(),'".$id_customer."','".$biaya."','".$faktur."','".$totalfaktur."','".$tunai."','".$transfer."','".$kartu."','".$piutang."','".$totalqty."','".$keterangan."','".$id_user."')") or die (mysql_error());
