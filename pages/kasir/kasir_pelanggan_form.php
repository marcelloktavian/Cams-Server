<div class="ui-widget ui-form">
    <div class="ui-widget-header ui-corner-top padding5">
        <?php
			...
			echo $action .' DATA PELANGGAN';
        ?>
    </div>
    <div class="ui-widget-content ui-corner-bottom">
        <form id="kasir_pelanggan_form" method="post" action="<?php echo BASE_URL ?>pages/kasir/kasir_pelanggan.php?action=process" class="ui-helper-clearfix">
        	<?php
