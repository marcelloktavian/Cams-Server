<?php
    ...
    // end validasi
        ...
        id_address,id_expedition,exp_code,exp_fee,note,aktif,state) SELECT '$idolnso','$ref',b.oln_tgl,b.oln_penerima, b.oln_address,
        ...
        b.oln_expnote,b.exp_fee,b.oln_note,'Y','0' FROM olnpreso b WHERE (b.oln_order_id = '$ref') ";
        ...
        SELECT '$idolnso',b.id_product,b.namabrg,b.size,b.jumlah_beli,$diskon,'$idolnauto',b.harga_satuan,b.subtotal,b.jumlah_beli FROM olnpreso b
