<?php
	...
	$grandtotal = $_POST['total'];
        ...
        b.oln_telp,b.tunai,b.transfer,sum(b.deposit),sum(b.jumlah_beli * (b.harga_satuan + b.tax)),'$totalfaktur','".$piutang."',SUM(b.jumlah_beli),b.id_dropshipper,'0',b.id_expedition,
        b.oln_expnote,b.exp_fee,'$disc_dropshipper','Y','0' FROM olnpreso_cr b WHERE (b.oln_order_id = '$ref') ";
        ...
        $qryupdateharga = "";
        $qryupdateharga = " UPDATE olnsodetail ols,olnpreso_cr d SET ols.harga_satuan = d.harga_satuan WHERE (ols.id_product = d.id_product) AND ols.id_trans='$idolnso' ";
