<?php
	...
	$grandtotal = $_POST['totalhidden'];
		...
		$queryMaster = " INSERT INTO olnso (id_trans,ref_kode,tgl_trans,nama,alamat,telp,tunai,transfer,deposit,faktur,total,piutang,totalqty,id_dropshipper,
        id_address,id_expedition,exp_code,exp_fee,discount,aktif,state,lastmodified,exp_note) SELECT '$idolnso','$ref',b.oln_tgl,b.oln_penerima, CONCAT('$alamat',' (kec ',b.oln_kecamatan,', ',b.oln_kotakab,', ',b.oln_provinsi,')') AS oln_address,
        b.oln_telp,'$tunai','$transfer','".$deposit."','".($totalakhir-$exp_fee)."','".($totalakhir)."','".$piutang."','".$totalqty."',b.id_dropshipper,'0','".$id_expedisi."','".$exp_code."','$exp_fee','$disc_dropshipper','Y','0',NOW(),'".$exp_note."' FROM olnpreso_cr b WHERE (b.oln_order_id = '$ref') limit 0,1";
