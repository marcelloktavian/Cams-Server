<?php
	...
	$grandtotal = $_POST['total'];
        ...
        b.oln_telp,'$tunai','$transfer','".$deposit."','$totalakhir','$totalakhir','".$piutang."','".$totalqty."',b.id_dropshipper,'0','".$id_expedisi."','".$exp_code."','$exp_fee','$disc_dropshipper','Y','0',NOW(),'".$exp_note."' FROM olnpreso_cr b WHERE (b.oln_order_id = '$ref') ";
