	...
	<table>
		...
		// var_dump($target_dir);die;
			...
			// var_dump($sql_insert);die;
						...
						if ($idnya == $Row[0]) {
							//update
							$sql_update="UPDATE `oln_xlscamou_cr` SET oln_ordertotal = '".$total."' WHERE oln_order_id='".$Row[0]."'";
		...
		<table class="table-fill">
			...
			while($d = mysql_fetch_array($data)){
				...
				<tr>
					...
					<td class="text-right"><?php echo number_format($d['oln_qty'] * ($d['oln_totalprice']+$d['oln_tax'])); ?></td>
