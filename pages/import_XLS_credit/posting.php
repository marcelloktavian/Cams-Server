...
// menghubungkan dengan koneksi
 include("../../include/koneksi.php");
	$sql_post="";
		...
		$sql_post="INSERT INTO olnpreso_cr(
		...
		,oln_kotakab,oln_kecamatan,oln_shipmethod,oln_tgl,id_dropshipper,id_product, id_expedition)
		...
		$sql_delete="";	
		$sql_delete="TRUNCATE TABLE oln_xlscamou_cr";	
		...
		// dropshiper init
		$sql_dropshiper="";
		$sql_dropshiper=" UPDATE olnpreso_cr olp,mst_dropshipper d SET olp.id_dropshipper = d.id WHERE  (olp.oln_customerid = d.oln_customer_id) ";
		$update_dropshipper=mysql_query($sql_dropshiper) or die (mysql_error());
	
		//inisialisasi deposit
		$sql_deposit="";
		$sql_deposit="UPDATE olnpreso_cr olp SET olp.deposit= (olp.subtotal + olp.tax) WHERE (olp.total = 0) AND (olp.state='0') ";
		$update_deposit=mysql_query($sql_deposit) or die (mysql_error());
		

// alihkan halaman ke importcamoucredit.php
header("location:importcamoucredit.php?posting=$posting");
?>