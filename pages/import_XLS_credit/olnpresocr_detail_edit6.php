...
<body>
	...
	<td><input type='text' class='inputform' name='exp_fee' id='exp_fee' placeholder='Biaya Ekspedisi' value='' onkeyup='hitungpiutang();'/></td>
...
function cetak(){
    ...
    { 
    	...
    	{	
    		...
    		document.form2.action="olnpresocr_save.php?action=save";
...
function cetak2(){
    ...
    { 
    	...
    	{	
    		...
    		document.form2.action="olnpresocr_post.php";
    		document.form2.submit();
    	}
    	else
    	{}
