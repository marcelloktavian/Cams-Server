<?php
	...
	$grandtotal = $_POST['total'];
        ...
        b.oln_telp,b.tunai,b.transfer,sum(b.deposit),sum(b.jumlah_beli * (b.harga_satuan + b.tax)),'$grandtotalolnso','".$piutang."',SUM(b.jumlah_beli),b.id_dropshipper,'0',b.id_expedition,
