<?php
	...
	$grandtotal = $_POST['total'];
		...
		// $queryMaster = " INSERT INTO olnso (id_trans,ref_kode,tgl_trans,nama,alamat,telp,tunai,transfer,deposit,faktur,total,piutang,totalqty,id_dropshipper,
  //       id_address,id_expedition,exp_code,exp_fee,discount,aktif,state,lastmodified) SELECT '$idolnso','$ref',b.oln_tgl,b.oln_penerima, b.oln_address,
  //       b.oln_telp,'$tunai','$transfer',sum(b.deposit),sum(b.jumlah_beli * (b.harga_satuan + b.tax)),'$totalakhir','".$piutang."',SUM(b.jumlah_beli),b.id_dropshipper,'0','".$id_expedisi."',
  //       b.oln_expnote,'$exp_fee','$disc_dropshipper','Y','0',NOW() FROM olnpreso_cr b WHERE (b.oln_order_id = '$ref') ";
         $queryMaster = " INSERT INTO olnso (id_trans,ref_kode,tgl_trans,nama,alamat,telp,tunai,transfer,deposit,faktur,total,piutang,totalqty,id_dropshipper,
        id_address,id_expedition,exp_code,exp_fee,discount,aktif,state,lastmodified) SELECT '$idolnso','$ref',b.oln_tgl,b.oln_penerima, CONCAT(b.oln_address,' (kec ',b.oln_kecamatan,', ',b.oln_kotakab,', ',b.oln_provinsi,')') AS oln_address,
        b.oln_telp,'$tunai','$transfer',sum(b.deposit),sum(b.jumlah_beli * (b.harga_satuan + b.tax)),'$totalakhir','".$piutang."',SUM(b.jumlah_beli),b.id_dropshipper,'0','".$id_expedisi."',
        b.oln_expnote,'$exp_fee','$disc_dropshipper','Y','0',NOW() FROM olnpreso_cr b WHERE (b.oln_order_id = '$ref') ";
        ...
        SELECT '$idolnso',b.id_product,b.namabrg,b.size,b.jumlah_beli,b.disc,'$idolnauto',b.harga_satuan,b.subtotal,b.jumlah_beli FROM olnpreso_cr b
