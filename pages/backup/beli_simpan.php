...
include("koneksi/koneksi.php");
	...
	for ($i=1; $i<$row; $i++)
	{
		...
		{
		//---simpan detail---
		$query = "INSERT INTO trbeli_detail(id_barang, id_trans, qty,harga) VALUES ('".$Id_Part."','".$id_pkb."','".$Qty."','".$Harga."')";
	...
	*/	
	...
	//--- simpan master ---------------------------
	mysql_query("insert into trbeli(id_trans,tgl_trans,id_supplier,totalfaktur,totalqty,id_user)values('".$id_pkb."',NOW(),'".$id_supplier."','".$totalfaktur."','".$totalqty."','".$id_user."')") or die (mysql_error());
	//---akhir simpan master----------------------
	}
	...
	//-update detail------------------------
        ...
        //echo "<script> alert('delete= $delete,id_detail=$id_detail');</script>";
			...
			else
			{
				...
				if($delete=='' && $id_detail==''){
				$sql_insert="insert into trbeli_detail(id_barang, id_trans,harga,qty) VALUES ('".$Id_Part."','".$_GET['id_trans']."','".$Harga."','".$Qty."')" ;
				...
				$sql_update="update trbeli_detail set id_barang = '".$Id_Part."', harga= '".$Harga."', qty= '".$Qty."' where id_detail = '".$id_detail."'";
		...
		//update master------------------------------
		mysql_query("update trbeli set totalfaktur='".$totalfaktur."', totalqty='".$totalqty."', id_supplier='".$_POST['id_supplier']."' where id_trans='".$_GET['id_trans']."'") or die (mysql_error());
