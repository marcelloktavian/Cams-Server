...
<body>	
		<table border ="1px">
			<thead>
                <tr>
                    <th colspan='8'>DATA PENJUALAN KREDIT</th>
                </tr>
				<tr>
            ...
            WHERE jurnal.keterangan LIKE '%Penjualan OLN Kredit%'");
	...
	<table border ="1px">
			<thead>
                <tr>
                    <th colspan='8'>DATA PENJUALAN KREDIT CANCELLED</th>
                </tr>
				<tr>
					<th class="text-left">No.</th>
					<th class="text-left">ID</th>
            ...
            WHERE jurnal.keterangan LIKE '%CANCELLED OLN Kredit%'");
			while($d = mysql_fetch_array($data)){
				?>
				<tr>
					<td class="text-left"><?php echo $no; ?></td>
