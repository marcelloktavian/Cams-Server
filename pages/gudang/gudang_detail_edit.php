<head>
<title>EDIT Penerimaan Gudang</title>
...
$().ready(function() {	
		$("#nama").autocomplete("gudang_mstgudang.php", {
		width: 158
  });
   ...
   $("#nama").result(function(event, data, formatted) {
	...
	$.ajax({
		url : 'gudang_lookup.php?nama='+nama,
		dataType: 'json',
		data: "nama="+formatted,
...
LEFT JOIN mst_gudang b ON b.id =a.id_gudang WHERE a.id_trans= '".$_GET['ids']."'")or die (mysql_error());
...
echo"<form id='form2' name='form2' action='' method='post'>
    <table width='100%'>
  	<tr>
    	<td  class='fontjudul'>EDIT Penerimaan Gudang</td>
...
<table width='100%' cellspacing='0' cellpadding='0'>
    <tr>
     ...
     <tr>
        <td class='fonttext'>Nama Gudang</td>
        <td><input type='text' class='inputform' name='nama' id='nama' placeholder='Autosuggest Nama Gudang'  />
...
<script type="text/javascript">
	...
	document.form2.id_gudang.value='<?=$rs['id_gudang'];?>';
...
function cetak(){
    ...
    else 
    {
		...
		{	
		hitungrow() ;
		document.form2.action="gudang_simpan.php?id_trans=<?=$_GET['ids']?>";
...
$sql1 = mysql_query("select a.id_detail,a.id_barang, b.nm_barang, a.qty, a.harga, (a.qty * a.harga) as subtotal,a.id_jenis,a.harga_yard  from trgudang_detail a, barang b where a.id_barang=b.id_barang and a.id_trans = '".$_GET['ids']."'");
$i=1;
