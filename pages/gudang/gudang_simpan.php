...
include("../../include/koneksi.php");
	...
	for ($i=1; $i<$row; $i++)
	{
		...
		{
		//---simpan detail---
		$query = "INSERT INTO trgudang_detail(id_barang, id_trans,id_jenis,harga_yard, qty,harga) VALUES ('".$Id_Part."','".$id_pkb."','".$id_jenis."','".$Harga_yard."','".$Qty."','".$Harga."')";
	...
	*/	
	...
	//--- simpan master ---------------------------
	mysql_query("insert into trgudang(id_trans,tgl_trans,id_gudang,totalfaktur,totalqty,id_user)values('".$id_pkb."','".$tgl."','".$id_gudang."','".$totalfaktur."','".$totalqty."','".$id_user."')") or die (mysql_error());
	//---akhir simpan master----------------------
	}
	...
	//-update detail------------------------
        ...
        //echo "<script> alert('delete= $delete,id_detail=$id_detail');</script>";
			...
			else
			{
				...
				if($delete=='' && $id_detail==''){
				$sql_insert="insert into trgudang_detail(id_barang, id_trans,id_jenis,harga_yard,harga,qty) VALUES ('".$Id_Part."','".$_GET['id_trans']."','".$id_jenis."','".$Harga_yard."','".$Harga."','".$Qty."')" ;
				...
				$sql_update="update trgudang_detail set id_barang = '".$Id_Part."',id_jenis= '".$id_jenis."', harga_yard= '".$Harga_yard."', harga= '".$Harga."', qty= '".$Qty."' where id_detail = '".$id_detail."'";
		...
		//update master------------------------------
		mysql_query("update trgudang set totalfaktur='".$totalfaktur."',tgl_trans='".$tgl."', totalqty='".$totalqty."', id_gudang='".$_POST['id_gudang']."' where id_trans='".$_GET['id_trans']."'") or die (mysql_error());
