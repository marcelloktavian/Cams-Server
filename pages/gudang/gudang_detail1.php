<head>
<title>Tambah Penerimaan Gudang</title>
...
{
	$q = mysql_fetch_array( mysql_query('select id_trans from trgudang order by id_trans desc limit 0,1'));
...
function getnewnotrxwait2()
{
	...
	$id="GKB".$temp."".str_pad($temp2, 4, 0, STR_PAD_LEFT);	
	return $id;
...
echo"<form id='form2' name='form2' action='' method='post'>
    <table width='100%'>
  	<tr>
		...
		<td class='fontjudul'>TAMBAH PENERIMAAN</td>
...
<table width='100%' cellspacing='0' cellpadding='0'>
    <tr>
     ...
     <tr>
        <td class='fonttext'>Gudang</td>
        <td><input type='text' class='inputform' name='nama' id='nama' placeholder='Autosuggest Gudang'  />
...
function cetak(){
	...
	if (pesan != '') {
        alert('Maaf, ada kesalahan pengisian Nota Pengiriman Barang : \n'+pesan);
        return false;
	}
	else
	{ */	
		...
		{	
		hitungrow() ;
		document.form2.action="gudang_simpan.php";
