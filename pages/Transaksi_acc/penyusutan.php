...
if (isset($_GET['action']) && strtolower($_GET['action']) == 'json') {
  ...
  if ($affected_rows > 0) {
    ...
    $r['stat'] = 0;
    $r['message'] = 'Aset gagal ditambahkan, Nilai pembelian tidak boleh nol';
  } else {
    $r['stat'] = 0;
  ...
  if ($affected_rows > 0) {
    $r['stat'] = 1;
    $r['message'] = 'Berhasil memberhentikan aset';
  } else {
    $r['stat'] = 0;
    $r['message'] = 'Gagal memberhentikan aset';
  }

  echo json_encode($r);
  exit();
} else if (isset($_GET['action']) && strtolower($_GET['action']) == 'passhapus') {
  include 'penyusutan_passhapus.php';
  exit();
  exit;
  ...
  $(document).ready(() => {
    $('#table_penyusutan').jqGrid({
      ...
      colModel: [{
        ...
        {
          name: 'tanggal_pembelian_aset',
          index: 'tanggal_pembelian_aset',
          align: 'center',
          width: 30,
          formatter: "date",
          formatoptions: {
        ...
        {
          name: 'durasi_penyusutan',
          index: 'durasi_penyusutan',
          align: 'center',
          width: 20,
          formatoptions: {
            srcformat: "Y-m-d",
        ...
        {
          name: 'nilai_beli_aset',
          index: 'nilai_beli_aset',
          align: 'right',
          width: 40,
          searchoptions: {
            sopt: ['cn']
        ...
        {
          name: 'nilai_sisa_aset',
          index: 'nilai_sisa_aset',
          align: 'right',
          width: 40,
          searchoptions: {
            sopt: ['cn']
        ...
        {
          name: 'total_penyusutan_saat_ini',
          index: '',
          align: 'center',
          width: 35,
          searchoptions: {
    ...
    $('#table_penyusutan').jqGrid('navGrid', '#pager_table_penyusutan', {
      edit: false,
      add: false,
      del: false,
      search: false
