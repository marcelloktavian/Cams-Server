...
include("../../include/koneksi.php");
	...
	*/
	// $sql_master="";
	$sql_master="insert into b2bso(id_trans,ref_kode,tgl_trans,tgl_buatpo,id_kategori,id_salesman,id_customer,nama,telp,alamat,id_address,id_expedition,exp_code,exp_fee,exp_note,total,faktur,totalqty,tunai,transfer,deposit,simpan_deposit,piutang,note,user)values('".$id_pkb."','".$ref_kode."','".$tgl."','".$tglpodibuat."','".$id_kategori."','".$id_salesman."','".$id_customer."','".$nama."','".$telp."','".$alamat."','".$id_address."','".$id_expedition."','".$exp_code."','".$exp_fee."','".$exp_note."','".$totalfaktur."','".$faktur."','".$totalqty."','".$tunai."','".$transfer."','".$byr_deposit."','".$simpan_deposit."','".$piutang."','".$keterangan."','".$id_user."')";
