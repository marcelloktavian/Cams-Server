...
function cetak(){
		...
		{	
			...
			// window.opener.document.getElementById("TotalHidden"+b+"").value = parseFloat($('#totalSebelumnya').val()) ;
...
WHERE `status` = 'pendapatan' AND a.id_penggajian='".$_GET['penggajian']."' AND a.id_karyawan='$id' AND b.kode_penpot IS NOT NULL AND b.metode_pethitungan = 'Manual Input' ";
