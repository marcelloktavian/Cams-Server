...
<?php
/*
    ///// PANGGIL CACHE GROUP ACCESS UTK CEK HAK AKSES 
        $group_access = unserialize(file_get_contents("../../GROUP_ACCESS_CACHE".$_SESSION['user']['group_id']));
        $allow_edit = is_show_menu(EDIT_POLICY, MENU_TOKO_KASIR, $group_access);
        $allow_delete = is_show_menu(DELETE_POLICY, MENU_TOKO_KASIR, $group_access);
*/
