...
td13.appendChild(generateQty(baris1));
td14.appendChild(generateKirim(baris1));
td15.appendChild(generateSisa(baris1));
td15.appendChild(generateSaldo(baris1));
td16.appendChild(generateDel1(baris1));
...
function hitungjml(a)
{
	...
	kirim=parseInt(kirim36)+parseInt(kirim37)+parseInt(kirim38)+parseInt(kirim39)+parseInt(kirim40)+parseInt(kirim41)+parseInt(kirim42)+parseInt(kirim43)+parseInt(kirim44)+parseInt(kirim45);
...
<?php 
$sql_edit = "Select a.*,(a.jumlah_beli-a.jumlah_kirim) as saldo,(a.qty36-a.kirim36) as saldo36,(a.qty37-a.kirim37) as saldo37,(a.qty38-a.kirim38) as saldo38,(a.qty39-a.kirim39) as saldo39,(a.qty40-a.kirim40) as saldo40,(a.qty41-a.kirim41) as saldo41,(a.qty42-a.kirim42) as saldo42,(a.qty43-a.kirim43) as saldo43,(a.qty44-a.kirim44) as saldo44,(a.qty45-a.kirim45) as saldo45 from b2bso_detail a where (a.id_trans = '".$_GET['ids']."') and ((a.jumlah_beli-a.jumlah_kirim) > 0)";
