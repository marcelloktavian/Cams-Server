...
<?php
	if(isset($_GET['action']) && strtolower($_GET['action']) == 'json') {
		...
		*/
        ...
        foreach($data1 as $line) {
			...
			{
				$edit = '<a onclick="javascript:custom_alert(\'Tidak Boleh Posting Data\')" href="javascript:;">Edit</a>';
	...
	elseif(isset($_GET['action']) && strtolower($_GET['action']) == 'delete') {
		...
		$stmt = $db->prepare("update b2bso_detail set jumlah_beli=0,harga_satuan=0,qty36=0,qty37=0,qty38=0,qty39=0,qty40=0,qty41=0,qty42=0,qty43=0,qty44=0,qty45=0,subtotal=0 WHERE id_trans=?");
		$stmt->execute(array($_GET['id']));
		//var_dump($stmt);die;
    ...
    */
    $(document).ready(function(){
        ...
        $("#table_jualb2b").jqGrid({
            ...
            datatype: "json",
            colNames:['ID','ID_ref','Customer','Date','Salesman','Address','Exp.Fee','Expedition','CAT','Qty','Edit','Posting','Cancel'],
            colModel:[
            ...
            subGridModel: [
			            	{ 
			            		name : ['No','Kode','Barang','S36','S37','S38','S39','S40','S41','S42','S43','S44','S45','Harga','Disc','Qty(pcs)','Subtotal'], 
			            		width : [40,40,300,10,10,10,10,10,10,10,10,10,10,50,50,50,50],
			            		align : ['right','center','left','center','center','center','center','center','center','center','center','center','center','right','right','right','right'],
			            	} 
			            ],
