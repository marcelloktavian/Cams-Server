...
include("../../include/koneksi.php");
	...
	$sql_deposit="";
	//$sql_deposit="Update tblpelanggan set deposit=deposit+".$sisa_deposit." where id=".$id_customer;
	    if($sisa_deposit > 0)
	    {
		$sql_deposit="insert into trdeposit(id_trans,kode,tgl_trans,id_customer,totalfaktur,tunai,deposit,catatan) values('".$id_pkb."','".$id_pkb."',NOW(),'".$id_customer."','".$sisa_deposit."','".$sisa_deposit."','".$sisa_deposit."','PIUTANG SIMPAN DEPOSIT')";
