...
<form id="form2" name="form2" action="" method="post"  onSubmit="return validasi(this)">
  ...
  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
	...
	//$id_detail=;
	$sq2 = mysql_query("SELECT GROUP_CONCAT(kode_brg)as kode_group,harga,sum(qty) as qty_sub,(harga * sum(qty)) as subtotal FROM trjual_detail where id_trans='".$_GET['id_trans']."' GROUP BY harga");
  ...
  ?>
    <tr>
      ...
      <td class="style9"><?=$rs2['kode_group'];?></td>
      <td class="style9"><div align="right">
        <?=number_format($rs2['harga'],0);?>
      </div></td>
      <td class="style9"><div align="right">
        <?=number_format($rs2['qty_sub'],0);?>
      </div></td>
      <td class="style9"><div align="right">
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td width="67%">&nbsp;</td>
      <td width="22%"><div align="right" class="style9"> Faktur Rp</div></td>
	...
	<tr>
      <td width="67%">&nbsp;</td>
      <td width="22%"><div align="right" class="style9"> Ongkir</div></td>
      <td width="11%"><div id="jmljasa">
        <div align="right" class="style9">
  ...
  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr>
      <td height="27" colspan="3"><p><span class="style20">Ketentuan </span> :<br />
          <span class="style20">1. Pembayaran dengan giro/cek dianggap sah setelah dapat dicairkan/dikliringkan</span>. <br />
