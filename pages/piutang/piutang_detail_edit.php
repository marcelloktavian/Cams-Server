...
function cetak(){
	...
	else
	{
		...
		{	
		hitungrow() ;
		document.form2.action="piutang_nota.php?id_trans=<?=$rs['id_trans'];?>";
...
<?php 
	$sql1 = mysql_query("select a.id_trans,a.id_transjual,b.tgl_trans,a.faktur,a.piutang,a.bayar,a.bank from trpiutang_detail a left join trjual b on (a.id_transjual=b.id_trans) where a.id_trans = '".$_GET['ids']."'");
    $i=1;
