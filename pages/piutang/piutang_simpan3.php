...
include("../../include/koneksi.php");
	...
	mysql_query("insert into trpiutang(id_trans,id_transjual,tgl_trans,id_customer,totalfaktur,totalqty,faktur,tunai,transfer,piutang,keterangan,info,id_user)values('".$id_pkb."','".$Id_Part."',NOW(),'".$id_customer."','".$totalfaktur."','".$totalqty."','".$faktur."','".$tunai."','".$transfer."','".$sisapiutang."','".$keterangan."','".$info."','".$id_user."')") or die (mysql_error());
	//---akhir simpan master----------------------
	}
