...
<form id="form2" name="form2" action="" method="post"  onSubmit="return validasi(this)">
  ...
  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
	...
	$sq2 = mysql_query("select a.id_transjual,DATE_FORMAT(b.tgl_trans,'%d-%m-%Y') as tgl_trans,a.faktur, a.bayar,a.bank,a.piutang,a.piutang_update,(a.piutang-a.piutang_update) as totalbyr from trpiutang_detail a left join trjual b on a.id_transjual = b.id_trans where a.id_trans ='".$id_faktur."'");
	//--------------------end trpiutangdetail---------------------------------
  ...
  ?>
    <tr>
      ...
      <td class="style9"><div align="left">Pelunasan 
	  </div>
	  </td>
