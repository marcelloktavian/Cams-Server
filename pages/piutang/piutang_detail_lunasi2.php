...
<?php 
	$sql1 = mysql_query("select a.id_trans,a.tgl_trans,a.faktur,a.totalfaktur,a.piutang,a.pelunasan,(a.piutang-a.pelunasan) as sisapiutang,b.namaperusahaan from trjual a left join tblpelanggan b on (a.id_customer=b.id) where a.id_trans = '".$_GET['ids']."'");
    $i=1;
