<head>
<title>TAMBAH PELUASAN PIUTANG</title>
...
echo"<form id='form2' name='form2' action='' method='post' onSubmit='return validasi_input(this)'>
    <table width='100%'>
  	<tr>
    	<td  class='fontjudul'>DETAIL PELUNASAN PIUTANG</td>
...
<thead>
    <tr>
    	...
    	<td align='center' width='10%' class='fonttext'>Tanggal Transaksi</td>
      	...
      	<td align='center' width='15%' class='fonttext'>Bayar</td>
...
{   
	...
	for (var i=1; i<=baris1;i++){
		...
		total+= parseInt(document.getElementById("Bayar["+i+"]").value);
		}
		//else
		//return false;
	}
