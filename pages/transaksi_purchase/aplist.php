...
if(isset($_GET['action']) && strtolower($_GET['action']) == 'json'){
  ...
  foreach($data1 as $line){
    ...
    $nomor_akun = (isset($line['y_no_akun']) && $line['y_no_akun'] != null ? $line['y_no_akun'] : $line['x_no_akun']);
...
elseif(isset($_GET['action']) && strtolower($_GET['action']) == 'pembayaran'){
  ...
  $sql_detail="INSERT INTO jurnal_detail VALUES(NULL,'$idparent','$idakun','$noakun','$namaakun','AP','0','".$_POST['payment_aplist']."','','0', '$id_user',NOW())";
  ...
  $stmt = $db->prepare("INSERT INTO jurnal_detail VALUES(NULL,'$idparent','$idakun_kredit','$noakun_kredit','$namaakun_kredit','AP','".$_POST['payment_aplist']."','0','','0', '$id_user',NOW())");
  $stmt->execute();
  ...
  $(document).ready(function(){
    ...
    $('#table_aplist').jqGrid({
      ...
      colModel      : [
        ...
        {name: 'total_remaining', index: 'grand_total_ap', align: 'right', width: 40, searchoptions: {sopt: ['cn']}},
        {name: 'total_payment', index: 'grand_total_ap', align: 'right', width: 40, searchoptions: {sopt: ['cn']}},
