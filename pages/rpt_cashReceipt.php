...
<?php
    ...
    $sql = "SELECT det.uraian, det.buktikas, det.no_akun, det.nama_akun, det.debet, det.kredit, mst.total_debet, mst.total_kredit, IF(mst.kode='','0',mst.kode) as kode, IF(mst.kasbon2='','0',mst.kasbon2) as kasbon2, date_format(tanggal,'%d %M %Y') as tgl
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr>
        <td colspan=7 class="style19" align="center">LAPORAN KAS HARIAN</td>
    </tr>
    <tr>
        <td colspan=7 class="style10" align="center"><div style="text-transform:uppercase">TANGGAL : <?=date_format($date2,"d F Y")?></div></td>
    </tr>
    <tr>
        <td colspan=7>&nbsp;</td>
    </tr>
  ...
  <tr>
        ...
        while ($data = mysql_fetch_array($result)){
          ...
          if($jumlah == 1){
            ...
            <!-- <tr>
              ...
              <td class='style_detail'><?=$data['tgl']?></td>
            ...
            <tr><?php
              if($jumlah == 1){
                ?><td class='style_detail_left'><div  align="right">&nbsp;</div></td>
              ...
              if($data['buktikas'] == ''){
                ?><td  class='style_detail'><div align="center">&nbsp;</div></td><?php
              }else{
                ?><td  class='style_detail'><div align="center"><?=$data['buktikas']?></div></td><?php
              }

              if($data['debet'] == '' || $data['debet']=='0'){
                ?><td  class='style_detail'><div align="right">&nbsp;</div></td><?php
              }else{
                if($jumlah == 1){
                  ?><td  class='style_detail'><div align="right">&nbsp;</div></td><?php
                }else{
            ...
            if($jumlah == 1){
              ...
              <tr>
                <td class='style_detail_left'><div  align="right">&nbsp;</div></td>
                <td  class='style_detail'><div align="center">&nbsp;</div></td>
                <td  class='style_detail'><div align="center">&nbsp;</div></td>
                <td  class='style_detail'><div align="center">&nbsp;</div></td>
                <td  class='style_detail'><div align="center">&nbsp;</div></td>
                <td  class='style_detail'><div align="center">&nbsp;</div></td>
    ...
    <tr>
        <td><div class='style_detail_left'>&nbsp;</div></td>
        <td><div class='style_detail' align='center'>Saldo Per : <?=date_format($date2,"d M Y")?></div></td>
        <td><div class='style_detail'>&nbsp;</div></td>
        <td><div class='style_detail'>&nbsp;</div></td>
        <td><div class='style_detail' align='right'><?=number_format($totdebet - $totkredit,0)?></div></td>
