				...
				<div>
					<ul id="browser" class="filetree">
						<li><span class="folder">Master Data</span>
							<ul>
								<li><span class="file" id="armada" rel="<?php echo BASE_URL ?>pages/armada.php">Armada</span></li>
								<li><span class="file" id="barang" rel="<?php echo BASE_URL ?>pages/barang.php">Barang</span></li>
								<li><span class="file" id="jenis_barang" rel="<?php echo BASE_URL ?>pages/jenisbarang.php">Jenis / Tipe Barang</span></li>
								<li><span class="file" id="pelanggan" rel="<?php echo BASE_URL ?>pages/pelanggan.php">Pelanggan</span></li>
								<li><span class="file" id="gudang" rel="<?php echo BASE_URL ?>pages/master/mstgudang.php">Gudang</span></li>
								<li><span class="file" id="supplier" rel="<?php echo BASE_URL ?>pages/supplier.php">Supplier</span></li>
								<li><span class="file" id="province" rel="<?php echo BASE_URL ?>pages/province.php">Province</span></li>
								<li><span class="file" id="city" rel="<?php echo BASE_URL ?>pages/city.php">city</span></li>
								<li><span class="file" id="project" rel="<?php echo BASE_URL ?>pages/project.php">Project</span></li>
								<li><span class="file" id="pengguna" rel="<?php echo BASE_URL ?>pages/users.php">Pengguna</span></li>
							</ul>
						</li>
						<li><span class="folder">Transaksi</span>
							<ul>
								...
								<li><span class="file" id="beli" rel="<?php echo BASE_URL ?>pages/beli/beli.php">Pengiriman Barang </span></li>
