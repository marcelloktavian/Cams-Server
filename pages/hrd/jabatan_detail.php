<!DOCTYPE HTML>
<head>
<title>ADD JABATAN DETAIL</title>
...
<table width='100%'>
<tr>
    <td class='fontjudul'>ADD JABATAN</td>
</tr>
</table>
...
<table width='100%' cellspacing='0' cellpadding='0'>
     ...
     <tr>
		...
		<td><input type='text' class='inputform' name='kode_jabatan' id='kode_jabatan' placeholder='Kode Jabatan'  /></td>
        <td class='fonttext'>Nama Jabatan</td>
		<td><input type='text' class='inputform' name='nama_jabatan' id='nama_jabatan' placeholder='Nama Jabatan'  /></td>
            ...
            <select class='inputform'  name='id_dept' id='id_dept'>
               ...
               <?php
                ...
                while($rs1=mysql_fetch_array($sql1)){
                    echo "<option value='".$rs1['id_dept']."'>".$rs1['nama_dept']."</option>";
                }
                ?>
            </select>
            </td>
	    <td class='fonttext'>Melapor Ke</td>
        <td><input type='text' class='inputform' name='melapor_ke' id='melapor_ke' placeholder='Melapor Ke'  />
	 </tr>
	 <tr>
	    <td class='fonttext'>Lokasi Kerja</td>
        <td><textarea  name='lokasi_kerja' id='lokasi_kerja' placeholder='Lokasi Kerja' rows='5' cols='70'></textarea></td>
        <td class='fonttext'>Ringkasan Jabatan</td>
        <td><textarea  name='ringkasan' id='ringkasan' placeholder='Ringkasan Jabatan' rows='5' cols='70'></textarea></td>
	 </tr>
     <tr>
	    <td class='fonttext'>Kualifikasi</td>
        <td><textarea class='textcustom' name='kualifikasi' id='kualifikasi' placeholder='Kualifikasi'></textarea></td>
        <td class='fonttext'>Tanggung Jawab</td>
        <td><textarea class='textcustom' name='tanggung_jawab' id='tanggung_jawab' placeholder='Tanggung Jawab'></textarea></td>
	 </tr>
     <tr>
	    <td class='fonttext'>Kondisi Pekerjaan</td>
        <td><textarea  name='kondisi_pekerjaan' id='kondisi_pekerjaan' placeholder='Kondisi Pekerjaan' rows='5' cols='70'></textarea></td>
	 </tr>
</table>
<hr>
</form>
...
function cetak(){
	...
	{ 
		...
		if (answer)
		{	
		document.form2.action="jabatan_save.php?action=add";
