<head>
<title>ADD FORMULA PPH 21 DETAIL</title>
...
<table width='100%'>
<tr>
    <td class='fontjudul'>ADD FORMULA PPH 21 DETAIL</td>
</tr>
</table>
...
<table width='100%' cellspacing='0' cellpadding='0'>
     ...
     <tr>
		...
		<td><input type='text' class='inputform' name='namapph21' id='namapph21' placeholder='Nama Formula'  />
		<td class='fonttext'>Keterangan</td>
        <td colspan=10><textarea name='keterangan' id='keterangan' placeholder='Keterangan' cols='50' rows='2' /></textarea></td>	
     </tr>
...
function cetak(){
	...
	{ 
		...
		{	
		hitungrow() ;
		document.form2.action="pph21_save.php?action=add&row="+baris1;
