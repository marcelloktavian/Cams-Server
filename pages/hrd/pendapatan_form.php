...
<div class="ui-widget ui-form">
    <div class="ui-widget-header ui-corner-top padding5">
        <?php
            ...
            echo $action .' Master Pendapatan';
        ?>
    </div>
    <div class="ui-widget-content ui-corner-bottom">
        <form id="pendapatan_form" method="post" action="<?php echo BASE_URL ?>pages/hrd/pendapatan.php?action=process" class="ui-helper-clearfix">
            <?php
            ...
            ?>
              <label for="kode_penpot" class="ui-helper-reset label-control">Kode Pendapatan</label>
            ...
            <label for="nama_penpot" class="ui-helper-reset label-control">Nama Pendapatan</label>
            <div class="ui-corner-all form-control">
            ...
            <label for="objek_pph21" class="ui-helper-reset label-control">Mempengaruhi Total Pendapatan</label>
            <div class="ui-corner-all form-control">
            ...
            <div class="ui-corner-all form-control">
                <select class="required" name="objek_pph21" id="objek_pph21">
                    <option >-choose(pilih)-</option>
                    <option value="Menambah" <?php if(isset($row['objek_pph21']) && $row['objek_pph21'] == 'Menambah'){echo "selected";} ?>>Menambah</option>
