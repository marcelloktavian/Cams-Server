...
<script type="text/javascript">
	...
	function gridReloadJual(){
		...
		jQuery("#table_olnreturcf").setGridParam({url:v_url,page:1}).trigger("reloadGrid");
	}
    ...
    $(document).ready(function(){
        ...
        $("#table_olnreturcf").jqGrid({
            ...
            colModel:[
                {name:'id_trans',index:'id_trans', width:10, search:true, stype:'text', searchoptions:{sopt:['cn']}},
                {name:'ref_kode',index:'ref_kode', width:20, search:true, stype:'text', searchoptions:{sopt:['cn']}},
                {name:'id_oln',index:'id_oln', width:25, searchoptions: {sopt:['cn']}},                
                {name:'dropshipper',index:'dropshipper', width:35, searchoptions: {sopt:['cn']}},                
                ...
                {name:'lastmodified',index:'lastmodified', width:30, searchoptions: {sopt:['cn']},formatter:"date", formatoptions:{srcformat:"Y-m-d", newformat:"d/m/Y"}, align:'center'},
                ...
                {name:'totalqty',index:'totalqty', align:'right', width:15, searchoptions: {sopt:['cn']}},
                ...
                {name:'unpost',index:'unpost', align:'center', width:25, sortable: false, search: false},
            ...
            rownumbers: true,
            sortorder: "desc",
            caption:"Data Retur Online Confirmed",
        ...
        $("#table_olnreturcf").jqGrid('navGrid','#pager_table_olnreturcf',{edit:false,add:false,del:false,search:false});
