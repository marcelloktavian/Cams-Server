...
<?php
	if(isset($_GET['action']) && strtolower($_GET['action']) == 'json') {
		...
		$startdate = isset($_GET['startdate_jualcr'])?$_GET['startdate_jualcr']:date('Y-m-d');
		$enddate = isset($_GET['enddate_jualcr'])?$_GET['enddate_jualcr']:date('Y-m-d'); 
...
<div class="ui-widget ui-form" style="margin-bottom:5px">
 <div class="ui-widget-header ui-corner-top padding5">
    ...
    <div class="ui-widget-content ui-corner-bottom">
        <form id="report_project_form" method="" action="" class="ui-helper-clearfix">
        	<label for="lbl_tanggal" class="ui-helper-reset label-control">Tanggal</label>
            ...
            <div class="ui-corner-all form-control">
            	<button onclick="gridReloadJualcr()" class="btn" type="button">Cari</button>
            </div>
       	</form>
   	</div>
</div>
 ...
 <a href="javascript: void(0)" 
   onclick="window.open('pages/sales_online/trolnso_detailcr.php');">
...
<script type="text/javascript">
	...
	function gridReloadJualcr(){
		var startdate_jualcr = $("#startdate_jualcr").val();
		var enddate_jualcr = $("#enddate_jualcr").val();
		var v_url ='<?php echo BASE_URL?>pages/sales_online/trolnsocr.php?action=json&startdate_jualcr='+startdate_jualcr+'&enddate_jualcr='+enddate_jualcr ;
