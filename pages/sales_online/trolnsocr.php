...
$allow_delete = is_show_menu(DELETE_POLICY, OnlineCredit, $group_acess);
	...
	elseif(isset($_GET['action']) && strtolower($_GET['action']) == 'posting') {
        ...
        // execute for master
        $sql_master="INSERT INTO `jurnal`(`no_jurnal`,`tgl`,`keterangan`, `total_debet`, `total_kredit`, `deleted`, `user`, `lastmodified`) VALUES ('$masterNo',NOW(),'Penjualan OLN Kredit - $namadropshipper - $idtrans','$total','$total','0','$id_user',NOW()) ";
...
>>>>>>> 656b64e0f1febf96f193dedfd53b00bc85a028e0
</script>