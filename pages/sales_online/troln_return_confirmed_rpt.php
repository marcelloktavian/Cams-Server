...
<form id="form2" name="form2" action="" method="post"  onSubmit="return validasi(this)">
  ...
  ?>
       <tr>
            ...
            <td colspan="1" class="style_title"><div align="right"><?=number_format($grand_subtotal);?></div></td>
       ...
       <tr>
            ...
            <td colspan="2" class="style_title"><div align="right"><?=number_format($totaldppbt);?></div></td>
       ...
       <tr>
            ...
            <td colspan="2" class="style_title"><div align="right"><?=number_format($totalppnbt);?></div></td>
