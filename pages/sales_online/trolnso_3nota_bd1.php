...
<!-- table 1---->
 ...
 while($m1=mysql_fetch_array($sql1)) {
  ...
  <table width="100%" border="0" class="cut-off "  align="center" cellpadding="0" cellspacing="0">
		  ...
		  <!-- 2 -->
		  <tr> 
		  <th colspan="8" class="style11btl_alamat" height="57.5"><div align="left">Penerima :<?=$m1['nama'];?>/<?=$m1['telp'];?><br><? echo "".$m1['alamat']." ".$m1['kecamatan']." ".$m1['kabupaten']." ".$m1['provinsi'];?></div></th>
	...
	<tr>
		  ...
		  <td colspan="4" class="style11btb" style="color: <?=$m1['kode_warna'];?>;font-weight: bold; border-style: solid; border-color: <?=$m1['kode_warna'];?>;"><div align="center"><?echo"".$exp_code;?></div></td>	
	</tr>
	<tr>
		<td>&nbsp;</td>		
    </tr>
