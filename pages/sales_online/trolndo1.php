...
<?php
	...
	elseif(isset($_GET['action']) && strtolower($_GET['action']) == 'delete') {
		...
		$stmt = $db->prepare("update olnso set state='0' WHERE id_trans=?");
 ...
 <div class="ui-widget-header ui-corner-top padding5">
    ...
    <div class="ui-widget-content ui-corner-bottom">
        <form id="report_project_form" method="" action="" class="ui-helper-clearfix">
        	<label for="project_id" class="ui-helper-reset label-control">Posting Dates</label>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $("#table_jualdo").jqGrid({
            ...
            colNames:['ID_ship','ID_oln','ID_web','Dropshipper','Date','Post.Date','Receiver','Address','Exp_fee','Expedition','Exp.Code','Qty','Invoice','Print','Cancel'],
            colModel:[
            ...
            rownumbers: true,
            sortorder: "desc",
            caption:"Data Online Siap Kirim(Ready)",
