...
<form id="form2" name="form2" action="" method="post"  onSubmit="return validasi(this)">
  <table width="100%" border="0"   align="center" cellpadding="0" cellspacing="0">
          <!-- 1 -->
		  <tr> 
		  <th style="border-top: 1px solid black;border-left: 1px solid black;" rowspan="2" colspan="2" ><center><img style="max-width:70%;max-height:70%;" src="../../files/Camou.png"></center></th> 
		  ...
		  <tr> 
		  <th colspan="4" class="style11btlr"><div align="left">Pelanggan(dropshipper) : <br/><?=$rs['dropshipper'];?></div></th>
	...
	{ $nomer++;
	  ...
	  $subtotal=$rs2['jumlah_beli'] * $harga_satuan;
	  $total+=$subtotal;
  ?>	  
		  <tr>
