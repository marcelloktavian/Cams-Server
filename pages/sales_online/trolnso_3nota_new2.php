...
<!-- table 1---->
 ...
 while($m1=mysql_fetch_array($sql1)) {
  ...
  <table width="100%" border="0" class="cut-off "  align="center" cellpadding="0" cellspacing="0">
		  ...
		  <th colspan="4" class="style11btlr"><div align="left">(<?=$m1['id_kirim'];?>)<?=$m1['id_trans'];?>/<?=$m1['ref_kode'];?></div></th>
          <td>&nbsp;</td>		  
		  <th colspan="4" class="style11btlr"><div align="left"><?=$m1['id_trans'];?>/<?=$m1['ref_kode'];?></div></th> 
 		  </tr> 
		  <!-- 2 -->
		  <tr> 
		  ...
		  -->
		  <th colspan="6" class="style11btlr"><div align="left">Penerima : <?=$m1['nama']?>/<?=$m1['telp'];?></div></th>
    ...
    <tr>
		  <td width="50%" class="style11btl_kirim"  colspan="3"><div align="left" style="color: <?=$m1['kode_warna'];?>;font-weight: bold; border-style: solid; border-color: <?=$m1['kode_warna'];?>;">&nbsp;EXP:<?=$m1['exp'];?>&nbsp;(<?=$m1['exp_code'];?>)</div></td>
		  <!--
	...
	<tr>
		  <td width="50%" class="style11btl"  colspan="3"><div align="left" >&nbsp;&nbsp;Note:<?=$m1['note'];?></div></td>
		  <td class="style11bt">&nbsp;</td>
		  <td class="style11bt">&nbsp;</td>
		  <td class="style11btr">&nbsp;</td>
	</tr>
