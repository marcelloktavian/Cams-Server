...
.style11btlr_detail2 {	color: #000000;
	font-size: 9pt;	
	font-family: Tahoma;
	border-top: 1px solid black;
	border-right: 1px solid black;
...
<!-- table 1---->
 ...
 while($m1=mysql_fetch_array($sql1)) {
  ...
  <table width="100%" border="0" class="cut-off "  align="center" cellpadding="0" cellspacing="0">
		  ...
		  <!-- 2 -->
		  <tr> 
		  <th colspan="8" class="style11btl_alamat" height="50"><div align="left">Penerima :<?=$m1['nama'];?>/<?=$m1['telp'];?><br><? echo "".$m1['alamat']." ".$m1['kecamatan']." ".$m1['kabupaten']." ".$m1['provinsi'];?></div></th>
          <th colspan="2" class="style11btlr_detail2"><div align="center" class="style_barcodeOLN">*<?=$m1['id_trans'];?>*</div></th> 
          </tr>
    ...
    <tr>
		  <td width="40%" class="style11btblr_note" rowspan="2" colspan="6"><div align="left">&nbsp;&nbsp;Note(<?=$m1['exp'];?>)&nbsp;=<?=$m1['note'];?></div></td>
		  <td width="20%" class="style11btr" colspan="1" ><div align="center"><img class="resize2" src="../../files/expedition/<?=$m1['logo'];?>.png"></div></td>
          		 
		  <td width="40%" class="style11btl_kirim" colspan="3" style="color: <?=$m1['kode_warna'];?>;font-weight: bold; border-style: solid; border-color: <?=$m1['kode_warna'];?>;"><div class="style_barcode" align="center" >*<?=$m1['exp_code'];?>*</div></td>
          
	</tr>
	<tr>
		  <td width="20%" colspan="1" class="style11btrb" ><div align="left">Ongkir=<?=$m1['exp_fee'];?></div></td>	
		  <td width="40%" colspan="3" class="style11btb" style="color: <?=$m1['kode_warna'];?>;font-weight: bold; font-size: 12px; border-style: solid; border-color: <?=$m1['kode_warna'];?>;"><div align="center"><?=$m1['exp_code'];?></div></td>	
	</tr>
	<tr>
		<td>&nbsp;</td>		
    </tr>
