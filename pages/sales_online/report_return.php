    ...
    <div class="ui-widget-content ui-corner-bottom">
        <form id="report_project_form" method="" action="" class="ui-helper-clearfix">
            ...
            <div class="ui-corner-all form-control">
                ...
                <div class="ui-corner-all form-control">
                    <button onclick="printolnreport()" class="btn" type="button">Cetak</button>
...
<script type="text/javascript">
    ...
    function printolnreport() {
        var startdate = $('#startdate_statb2bdo').val();
        var enddate = $('#enddate_statb2bdo').val();
        // console.log(filter+' '+lokasi_list);

        window_open('<?php echo BASE_URL ?>pages/sales_online/rpt_return.php?action=preview&type=' + $('#type_statb2bdo').val() + '&start=' + startdate + '&end=' + enddate);
