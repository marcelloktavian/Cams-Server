<div class="ui-widget ui-form">
    <div class="ui-widget-header ui-corner-top padding5">
        <?php
			...
			echo $action .' DATA DEPOSIT PELANGGAN';
        ?>
    </div>
    <div class="ui-widget-content ui-corner-bottom">
        <form id="pelanggan_toko_form" method="post" action="<?php echo BASE_URL ?>pages/kasir/deposit_pelanggan.php?action=process" class="ui-helper-clearfix">
        	<?php
				...
				//max id for kode pelanggan--------------------
					$select2 = $db->prepare("Select max(substring(id_cust,3,3)+1) as kode from tblpelanggan where id_cust like 'TK%' and type=2");
					$select2->execute();
