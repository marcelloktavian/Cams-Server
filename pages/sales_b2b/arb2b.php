  ...
  $(document).ready(()=>{
    $('#table_b2bar').jqGrid({
      ...
      colModel      : [
        ...
        {name: 'total_b2bar', index: 'total_b2bar', align: 'left', width: 40, searchoptions:{sopt: ['cn']}},
        {name: 'keterangan_b2bar', index: 'keterangan_b2bar', align: 'center', width: 80, searchoptions:{sopt: ['cn']}},
