...
include("../../include/koneksi.php");
	...
	$tgl   			  = $_POST['tanggal']; 
	$tglpodibuat   	  = $_POST['tanggalpodibuat']; 
	$tglestimasi   	  = $_POST['tanggalestimasi']; 
	...
	*/
	...
	for ($i=1; $i<$row; $i++)
	{
		...
		{
		//---simpan detail---
		$query = "INSERT INTO b2bso_detail( id_trans,id_product,namabrg,harga_satuan,harga_act,disc,jumlah_beli,id31,qty31,id32,qty32,id33,qty33,id34,qty34,id35,qty35,id36,qty36,id37,qty37,id38,qty38,id39,qty39,id40,qty40,id41,qty41,id42,qty42,id43,qty43,id44,qty44,id45,qty45,id46,qty46,subtotal) VALUES ('".$id_pkb."','".$id_product."','".$namabrg."','".$Harga."','".$Pricelist."','".$Disc."','".$Qty."','".$s31id."','".$qty31."','".$s32id."','".$qty32."','".$s33id."','".$qty33."','".$s34id."','".$qty34."','".$s35id."','".$qty35."','".$s36id."','".$qty36."','".$s37id."','".$qty37."','".$s38id."','".$qty38."','".$s39id."','".$qty39."','".$s40id."','".$qty40."','".$s41id."','".$qty41."','".$s42id."','".$qty42."','".$s43id."','".$qty43."','".$s44id."','".$qty44."','".$s45id."','".$qty45."','".$s46id."','".$qty46."','".$Subtotal."')";
		//var_dump($query);die;
	...
	*/
	// $sql_master="";
	$sql_master="insert into b2bso(id_trans,ref_kode,tgl_trans,tgl_buatpo,tgl_estimasi,id_kategori,id_salesman,id_customer,nama,telp,alamat,id_address,id_expedition,exp_code,exp_fee,exp_note,total,faktur,totalqty,tunai,transfer,deposit,simpan_deposit,piutang,note,user)values('".$id_pkb."','".$ref_kode."','".$tgl."','".$tglpodibuat."','".$tglestimasi."','".$id_kategori."','".$id_salesman."','".$id_customer."','".$nama."','".$telp."','".$alamat."','".$id_address."','".$id_expedition."','".$exp_code."','".$exp_fee."','".$exp_note."','".$totalfaktur."','".$faktur."','".$totalqty."','".$tunai."','".$transfer."','".$byr_deposit."','".$simpan_deposit."','".$piutang."','".$keterangan."','".$id_user."')";
		...
		$s46id = $_POST['S46id'.$i];
			...
			else
			{
				...
				*/
				...
				$sql_update="update b2bso_detail set id_product = '".$id_product."', id_trans= '".$id_pkb."', namabrg= '".$namabrg."', harga_satuan= '".$Harga."', harga_act= '".$Pricelist."', jumlah_beli= '".$Qty."',id31='".$s31id."',qty31='".$qty31."',id32='".$s32id."',qty32='".$qty32."',id33='".$s33id."',qty33='".$qty33."',id34='".$s34id."',qty34='".$qty34."',id35='".$s35id."',qty35='".$qty35."',id36='".$s36id."',qty36='".$qty36."',id37='".$s37id."',qty37='".$qty37."',id38='".$s38id."',qty38='".$qty38."',id39='".$s39id."',qty39='".$qty39."',id40='".$s40id."',qty40='".$qty40."',id41='".$s41id."',qty41='".$qty41."',id42='".$s42id."',qty42='".$qty42."',id43='".$s43id."',qty43='".$qty43."',id44='".$s44id."',qty44='".$qty44."',id45='".$s45id."',qty45='".$qty45."',id46='".$s46id."',qty46='".$qty46."',disc='".$Disc."',subtotal='".$Subtotal."' where b2bso_id = '".$id_detail."'";
