...
include("../../include/koneksi.php");
	...
	*/
	...
	for ($i=1; $i<$row; $i++)
	{
		...
		{
		//---simpan detail---
		$query = "INSERT INTO b2bso_detail( id_trans,id_product,namabrg,harga_satuan,harga_act,disc,jumlah_beli,id36,qty36,id37,qty37,id38,qty38,id39,qty39,id40,qty40,id41,qty41,id42,qty42,id43,qty43,id44,qty44,id45,qty45,subtotal) VALUES ('".$id_pkb."','".$id_product."','".$namabrg."','".$Harga."','".$Pricelist."','".$Disc."','".$Qty."','".$s36id."','".$qty36."','".$s37id."','".$qty37."','".$s38id."','".$qty38."','".$s39id."','".$qty39."','".$s40id."','".$qty40."','".$s41id."','".$qty41."','".$s42id."','".$qty42."','".$s43id."','".$qty43."','".$s44id."','".$qty44."','".$s45id."','".$qty45."','".$Subtotal."')";
		//var_dump($query);die;
		...
		$s45id = $_POST['S37id'.$i];
			...
			else
			{
				...
				*/
				...
				$sql_update="update b2bso_detail set id_product = '".$id_product."', id_trans= '".$id_pkb."', namabrg= '".$namabrg."', harga_satuan= '".$Harga."', harga_act= '".$Pricelist."', jumlah_beli= '".$Qty."',id36='".$s36id."',qty36='".$qty36."',id37='".$s37id."',qty37='".$qty37."',id38='".$s38id."',qty38='".$qty38."',id39='".$s39id."',qty39='".$qty39."',id40='".$s40id."',qty40='".$qty40."',id41='".$s41id."',qty41='".$qty41."',id42='".$s42id."',qty42='".$qty42."',id43='".$s43id."',qty43='".$qty43."',id44='".$s44id."',qty44='".$qty44."',id45='".$s45id."',qty45='".$qty45."',subtotal='".$Subtotal."' where b2bso_id = '".$id_detail."'";
