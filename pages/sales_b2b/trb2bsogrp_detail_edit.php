...
$().ready(function() {	
	...
	//alert("id_d="+id_d);
	$.ajax({
		url : 'lookup_salesman_ambil.php?id='+id_d+'&action=normal',
		dataType: 'json',
		data: "nama="+formatted,
 ...
 //        }
	...
	$.ajax({
		...
		success: function(data) {
			...
			$.ajax({
					url : 'lookup_salesman_ambil.php?id='+id_kategori+'&action=category',
					dataType: 'json',
					data: "nama="+formatted,
					success: function(data) {
						var id_salesman  = data.id;
...
echo"<form id='form2' name='form2' action='' method='post'>
    <table width='100%'>
  	<tr>
    	<td  class='fontjudul'>EDIT B2B ORDER INPUT $customer</td>
...
<table width='100%' cellspacing='0' cellpadding='0'>
    <tr>
	 ...
	 <tr>
		...
		<td class='fonttext'>Tanggal Estimasi Pengiriman</td>
		<td><input type='date'  id='tanggalestimasi' name='tanggalestimasi' class='datepicker'></td>
	 </tr>
	 <tr>
...
<script type="text/javascript">
	...
	document.form2.tanggalpodibuat.value='<?php echo date('Y-m-d',strtotime($rs['tgl_buatpo']));?>';
	document.form2.tanggalestimasi.value='<?php echo date('Y-m-d',strtotime($rs['tgl_estimasi']));?>';
...
function hitungjml(a)
{
	...
	if((document.getElementById("S37_"+a+"").value == "")||(document.getElementById("S37id"+a+"").value == "")||(document.getElementById("S37id"+a+"").value == 0)) {
	var qty37 = 0;	    
	}
	else{
	...
	if((document.getElementById("S38_"+a+"").value == "")||(document.getElementById("S38id"+a+"").value == "")||(document.getElementById("S38id"+a+"").value == 0)) {
		var qty38 = 0;	    
	}
	else{
	...
	if((document.getElementById("S39_"+a+"").value == "")||(document.getElementById("S39id"+a+"").value == "")||(document.getElementById("S39id"+a+"").value == 0))
	{
		var qty39 = 0;	    
	}
	else{
	...
	if((document.getElementById("S40_"+a+"").value == "")||(document.getElementById("S40id"+a+"").value == "")||(document.getElementById("S40id"+a+"").value == 0)) 
	{
		var qty40 = 0;	    
	}
	else{
	...
	if((document.getElementById("S41_"+a+"").value == "")||(document.getElementById("S41id"+a+"").value == "")||(document.getElementById("S41id"+a+"").value == 0)) 
	{
		var qty41 = 0;	    
	}
	else{
	...
	if((document.getElementById("S42_"+a+"").value == "")||(document.getElementById("S42id"+a+"").value == "")||(document.getElementById("S42id"+a+"").value == 0)) {
		var qty42 = 0;	    
	}
	else{
	...
	if((document.getElementById("S43_"+a+"").value == "")||(document.getElementById("S43id"+a+"").value == "")||(document.getElementById("S43id"+a+"").value == 0)) {
		var qty43 = 0;	    
	}
	else{
	...
	if((document.getElementById("S44_"+a+"").value == "")||(document.getElementById("S44id"+a+"").value == "")||(document.getElementById("S44id"+a+"").value == 0)) {
		var qty44 = 0;	    
	}
	else{
	...
	if((document.getElementById("S45_"+a+"").value == "")||(document.getElementById("S45id"+a+"").value == "")||(document.getElementById("S45id"+a+"").value == 0)) {
		var qty45 = 0;	    
	}
	else{
	...
	if((document.getElementById("S46_"+a+"").value == "")||(document.getElementById("S46id"+a+"").value == "")||(document.getElementById("S46id"+a+"").value == 0)) {
		var qty46 = 0;	    
	}
	else{
...
<?php 
	...
	while($rs1=mysql_fetch_array($sql1)){
		?>
			...
			//validasi ukuran
			$sql31 = "SELECT * FROM `mst_b2bproductsgrp_detail` WHERE `id_productsgrp`='".$rs1['id_product']."' AND size='31'";
			$sq31 = mysql_num_rows(mysql_query($sql31));
			if ($sq31==0) {
				?>document.getElementById('S31_'+<?=$i;?>+'').style.backgroundColor="grey";<?php
			} else {
				?>document.getElementById('S31_'+<?=$i;?>+'').style.backgroundColor="white";<?php	
			}
			
			$sql32 = "SELECT * FROM `mst_b2bproductsgrp_detail` WHERE `id_productsgrp`='".$rs1['id_product']."' AND size='32'";
			$sq32 = mysql_num_rows(mysql_query($sql32));
			if ($sq32==0) {
				?>document.getElementById('S32_'+<?=$i;?>+'').style.backgroundColor="grey";<?php
			} else {
				?>document.getElementById('S32_'+<?=$i;?>+'').style.backgroundColor="white";<?php	
			}

			$sql33 = "SELECT * FROM `mst_b2bproductsgrp_detail` WHERE `id_productsgrp`='".$rs1['id_product']."' AND size='33'";
			$sq33 = mysql_num_rows(mysql_query($sql33));
			if ($sq33==0) {
				?>document.getElementById('S33_'+<?=$i;?>+'').style.backgroundColor="grey";<?php
			} else {
				?>document.getElementById('S33_'+<?=$i;?>+'').style.backgroundColor="white";<?php	
			}

			$sql34 = "SELECT * FROM `mst_b2bproductsgrp_detail` WHERE `id_productsgrp`='".$rs1['id_product']."' AND size='34'";
			$sq34 = mysql_num_rows(mysql_query($sql34));
			if ($sq34==0) {
				?>document.getElementById('S34_'+<?=$i;?>+'').style.backgroundColor="grey";<?php
			} else {
				?>document.getElementById('S34_'+<?=$i;?>+'').style.backgroundColor="white";<?php	
			}

			$sql35 = "SELECT * FROM `mst_b2bproductsgrp_detail` WHERE `id_productsgrp`='".$rs1['id_product']."' AND size='35'";
			$sq35 = mysql_num_rows(mysql_query($sql35));
			if ($sq35==0) {
				?>document.getElementById('S35_'+<?=$i;?>+'').style.backgroundColor="grey";<?php
			} else {
				?>document.getElementById('S35_'+<?=$i;?>+'').style.backgroundColor="white";<?php	
			}

			$sql36 = "SELECT * FROM `mst_b2bproductsgrp_detail` WHERE `id_productsgrp`='".$rs1['id_product']."' AND size='36'";
			$sq36 = mysql_num_rows(mysql_query($sql36));
			if ($sq36==0) {
				?>document.getElementById('S36_'+<?=$i;?>+'').style.backgroundColor="grey";<?php
			} else {
				?>document.getElementById('S36_'+<?=$i;?>+'').style.backgroundColor="white";<?php	
			}
			...
			$sql37 = "SELECT * FROM `mst_b2bproductsgrp_detail` WHERE `id_productsgrp`='".$rs1['id_product']."' AND size='37'";
			$sq37 = mysql_num_rows(mysql_query($sql37));
			if ($sq37==0) {
				?>document.getElementById('S37_'+<?=$i;?>+'').style.backgroundColor="grey";<?php
			} else {
				?>document.getElementById('S37_'+<?=$i;?>+'').style.backgroundColor="white";<?php	
			}

			$sql38 = "SELECT * FROM `mst_b2bproductsgrp_detail` WHERE `id_productsgrp`='".$rs1['id_product']."' AND size='38'";
			$sq38 = mysql_num_rows(mysql_query($sql38));
			if ($sq38==0) {
				?>document.getElementById('S38_'+<?=$i;?>+'').style.backgroundColor="grey";<?php
			} else {
				?>document.getElementById('S38_'+<?=$i;?>+'').style.backgroundColor="white";<?php	
			}

			$sql39 = "SELECT * FROM `mst_b2bproductsgrp_detail` WHERE `id_productsgrp`='".$rs1['id_product']."' AND size='39'";
			$sq39 = mysql_num_rows(mysql_query($sql39));
			if ($sq39==0) {
				?>document.getElementById('S39_'+<?=$i;?>+'').style.backgroundColor="grey";<?php
			} else {
				?>document.getElementById('S39_'+<?=$i;?>+'').style.backgroundColor="white";<?php	
			}

			$sql40 = "SELECT * FROM `mst_b2bproductsgrp_detail` WHERE `id_productsgrp`='".$rs1['id_product']."' AND size='40'";
			$sq40 = mysql_num_rows(mysql_query($sql40));
			if ($sq40==0) {
				?>document.getElementById('S40_'+<?=$i;?>+'').style.backgroundColor="grey";<?php
			} else {
				?>document.getElementById('S40_'+<?=$i;?>+'').style.backgroundColor="white";<?php	
			}

			$sql41 = "SELECT * FROM `mst_b2bproductsgrp_detail` WHERE `id_productsgrp`='".$rs1['id_product']."' AND size='41'";
			$sq41 = mysql_num_rows(mysql_query($sql41));
			if ($sq41==0) {
				?>document.getElementById('S41_'+<?=$i;?>+'').style.backgroundColor="grey";<?php
			} else {
				?>document.getElementById('S41_'+<?=$i;?>+'').style.backgroundColor="white";<?php	
			}

			$sql42 = "SELECT * FROM `mst_b2bproductsgrp_detail` WHERE `id_productsgrp`='".$rs1['id_product']."' AND size='42'";
			$sq42 = mysql_num_rows(mysql_query($sql42));
			if ($sq42==0) {
				?>document.getElementById('S42_'+<?=$i;?>+'').style.backgroundColor="grey";<?php
			} else {
				?>document.getElementById('S42_'+<?=$i;?>+'').style.backgroundColor="white";<?php	
			}

			$sql43 = "SELECT * FROM `mst_b2bproductsgrp_detail` WHERE `id_productsgrp`='".$rs1['id_product']."' AND size='43'";
			$sq43 = mysql_num_rows(mysql_query($sql43));
			if ($sq43==0) {
				?>document.getElementById('S43_'+<?=$i;?>+'').style.backgroundColor="grey";<?php
			} else {
				?>document.getElementById('S43_'+<?=$i;?>+'').style.backgroundColor="white";<?php	
			}

			$sql44 = "SELECT * FROM `mst_b2bproductsgrp_detail` WHERE `id_productsgrp`='".$rs1['id_product']."' AND size='44'";
			$sq44 = mysql_num_rows(mysql_query($sql44));
			if ($sq44==0) {
				?>document.getElementById('S44_'+<?=$i;?>+'').style.backgroundColor="grey";<?php
			} else {
				?>document.getElementById('S44_'+<?=$i;?>+'').style.backgroundColor="white";<?php	
			}

			$sql45 = "SELECT * FROM `mst_b2bproductsgrp_detail` WHERE `id_productsgrp`='".$rs1['id_product']."' AND size='45'";
			$sq45 = mysql_num_rows(mysql_query($sql45));
			if ($sq45==0) {
				?>document.getElementById('S45_'+<?=$i;?>+'').style.backgroundColor="grey";<?php
			} else {
				?>document.getElementById('S45_'+<?=$i;?>+'').style.backgroundColor="white";<?php	
			}

			$sql46 = "SELECT * FROM `mst_b2bproductsgrp_detail` WHERE `id_productsgrp`='".$rs1['id_product']."' AND size='46'";
			$sq46 = mysql_num_rows(mysql_query($sql46));
			if ($sq45==0) {
				?>document.getElementById('S46_'+<?=$i;?>+'').style.backgroundColor="grey";<?php
			} else {
				?>document.getElementById('S46_'+<?=$i;?>+'').style.backgroundColor="white";<?php	
			}
			...
			document.getElementById('S31_'+<?=$i;?>+'').value = '<?=$rs1['qty31'];?>';
			document.getElementById('S32id'+<?=$i;?>+'').value = '<?=$rs1['id32'];?>';
			document.getElementById('S32_'+<?=$i;?>+'').value = '<?=$rs1['qty32'];?>';
			document.getElementById('S33id'+<?=$i;?>+'').value = '<?=$rs1['id33'];?>';
			document.getElementById('S33_'+<?=$i;?>+'').value = '<?=$rs1['qty33'];?>';
			document.getElementById('S34id'+<?=$i;?>+'').value = '<?=$rs1['id34'];?>';
			document.getElementById('S34_'+<?=$i;?>+'').value = '<?=$rs1['qty34'];?>';
			document.getElementById('S35id'+<?=$i;?>+'').value = '<?=$rs1['id35'];?>';
			document.getElementById('S35_'+<?=$i;?>+'').value = '<?=$rs1['qty35'];?>';
