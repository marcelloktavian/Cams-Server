...
<p><input type='image' value='batal' src='../../assets/images/batal.png'  id='baru'  onClick='tutup()'/></p>
	...
	*/
			...
			document.getElementById("total").value = total.toLocaleString('IND', {
				style: 'currency',
				currency: 'IDR'
			})
	...
	*/
		...
		?>
			...
			if ($sq31 == 0) {
			?>document.getElementById('S31_' + <?= $i; ?> + '').style.backgroundColor = "grey";
			<?php
			} else {
			?>document.getElementById('S31_' + <?= $i; ?> + '').style.backgroundColor = "white";
			<?php
			}
			...
			if ($sq32 == 0) {
			?>document.getElementById('S32_' + <?= $i; ?> + '').style.backgroundColor = "grey";
			<?php
			} else {
			?>document.getElementById('S32_' + <?= $i; ?> + '').style.backgroundColor = "white";
			<?php
			}
			...
			if ($sq33 == 0) {
			?>document.getElementById('S33_' + <?= $i; ?> + '').style.backgroundColor = "grey";
			<?php
			} else {
			?>document.getElementById('S33_' + <?= $i; ?> + '').style.backgroundColor = "white";
			<?php
			}
			...
			if ($sq34 == 0) {
			?>document.getElementById('S34_' + <?= $i; ?> + '').style.backgroundColor = "grey";
			<?php
			} else {
			?>document.getElementById('S34_' + <?= $i; ?> + '').style.backgroundColor = "white";
			<?php
			}
			...
			if ($sq35 == 0) {
			?>document.getElementById('S35_' + <?= $i; ?> + '').style.backgroundColor = "grey";
			<?php
			} else {
			?>document.getElementById('S35_' + <?= $i; ?> + '').style.backgroundColor = "white";
			<?php
			}
			...
			if ($sq36 == 0) {
			?>document.getElementById('S36_' + <?= $i; ?> + '').style.backgroundColor = "grey";
			<?php
			} else {
			?>document.getElementById('S36_' + <?= $i; ?> + '').style.backgroundColor = "white";
			<?php
			}
			...
			if ($sq37 == 0) {
			?>document.getElementById('S37_' + <?= $i; ?> + '').style.backgroundColor = "grey";
			<?php
			} else {
			?>document.getElementById('S37_' + <?= $i; ?> + '').style.backgroundColor = "white";
			<?php
			}
			...
			if ($sq38 == 0) {
			?>document.getElementById('S38_' + <?= $i; ?> + '').style.backgroundColor = "grey";
			<?php
			} else {
			?>document.getElementById('S38_' + <?= $i; ?> + '').style.backgroundColor = "white";
			<?php
			}
			...
			if ($sq39 == 0) {
			?>document.getElementById('S39_' + <?= $i; ?> + '').style.backgroundColor = "grey";
			<?php
			} else {
			?>document.getElementById('S39_' + <?= $i; ?> + '').style.backgroundColor = "white";
			<?php
			}
			...
			if ($sq40 == 0) {
			?>document.getElementById('S40_' + <?= $i; ?> + '').style.backgroundColor = "grey";
			<?php
			} else {
			?>document.getElementById('S40_' + <?= $i; ?> + '').style.backgroundColor = "white";
			<?php
			}
			...
			if ($sq41 == 0) {
			?>document.getElementById('S41_' + <?= $i; ?> + '').style.backgroundColor = "grey";
			<?php
			} else {
			?>document.getElementById('S41_' + <?= $i; ?> + '').style.backgroundColor = "white";
			<?php
			}
			...
			if ($sq42 == 0) {
			?>document.getElementById('S42_' + <?= $i; ?> + '').style.backgroundColor = "grey";
			<?php
			} else {
			?>document.getElementById('S42_' + <?= $i; ?> + '').style.backgroundColor = "white";
			<?php
			}
			...
			if ($sq43 == 0) {
			?>document.getElementById('S43_' + <?= $i; ?> + '').style.backgroundColor = "grey";
			<?php
			} else {
			?>document.getElementById('S43_' + <?= $i; ?> + '').style.backgroundColor = "white";
			<?php
			}
			...
			if ($sq44 == 0) {
			?>document.getElementById('S44_' + <?= $i; ?> + '').style.backgroundColor = "grey";
			<?php
			} else {
			?>document.getElementById('S44_' + <?= $i; ?> + '').style.backgroundColor = "white";
			<?php
			}
			...
			if ($sq45 == 0) {
			?>document.getElementById('S45_' + <?= $i; ?> + '').style.backgroundColor = "grey";
			<?php
			} else {
			?>document.getElementById('S45_' + <?= $i; ?> + '').style.backgroundColor = "white";
			<?php
			}
			...
			if ($sq45 == 0) {
			?>document.getElementById('S46_' + <?= $i; ?> + '').style.backgroundColor = "grey";
			<?php
			} else {
			?>document.getElementById('S46_' + <?= $i; ?> + '').style.backgroundColor = "white";
		<?php
			}
