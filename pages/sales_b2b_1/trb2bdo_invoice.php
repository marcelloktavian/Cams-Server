...
<form id="form2" name="form2" action="" method="post"  onSubmit="return validasi(this)">
	<table width="100%" border="0"   align="center" cellpadding="0" cellspacing="0">
		  ...
		  <th width="2.5%" class="style11btlr_title"><div align="center">46</div></th>
	...
	{ $nomer++;
	  ...
	  if ($kode!=$rs2['id_trans'])
	  {
		...
		echo "<td class='style11btl_detail'><div align='right'>".$rs2['s45']."</div></td>";
		echo "<td class='style11btlr_detail'><div align='right'>".$rs2['s46']."</div></td>";
