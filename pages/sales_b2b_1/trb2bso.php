	 ...
	 function getSelectedRows() {
        ...
        */
		...
		$("#table_jualb2b").jqGrid({
			...
			subGridModel: [
			{ 
				name : ['No','Kode','Barang','S36','S37','S38','S39','S40','S41','S42','S43','S44','S45','S46','Harga','Disc','Qty(pcs)','Subtotal'], 
				width : [40,40,300,10,10,10,10,10,10,10,10,10,10,10,50,50,50,50],
				align : ['right','center','left','center','center','center','center','center','center','center','center','center','center','center','right','right','right','right'],
			} 
			],
