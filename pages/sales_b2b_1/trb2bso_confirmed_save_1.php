...
include("../../include/koneksi.php");
	...
	$id_expedition = $_POST['id_salesman'];
	...
	for ($i=1; $i<$row; $i++)
	{
		...
		{
		//---simpan detail---
		$query = "INSERT INTO b2bdo_detail( id_trans,id_b2bso_det,id_product,namabrg,id36,qty36,id37,qty37,id38,qty38,id39,qty39,id40,qty40,id41,qty41,id42,qty42,id43,qty43,id44,qty44,id45,qty45,harga_satuan,jumlah_beli,jumlah_kirim,sisa,disc) VALUES ('".$id_pkb."','".$id_detail."','".$id_product."','".$NamaBrg."','".$id36."','".$k36."','".$id37."','".$k37."','".$id38."','".$k38."','".$id39."','".$k39."','".$id40."','".$k40."','".$id41."','".$k41."','".$id42."','".$k42."','".$id43."','".$k43."','".$id44."','".$k44."','".$id45."','".$k45."','".$Harga."','".$Qty."','".$QtyKirim."','".$Sisa."','".$Disc."')";
		//var_dump($query);die;
		...
		mysql_query($update_36) or die ("update kirim44 di b2bso_detail ERROR".mysql_error());
		}
		if ($id45 >0)
		{
		$update_45 = "";
