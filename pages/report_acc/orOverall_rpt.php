...
<table width="100%" align="center" cellpadding="0" cellspacing="0">
    ...
    $sql = "SELECT 
        ...
        SELECT 
            ...
            SUM(CASE WHEN YEAR(b.tgl) >= '$year' THEN a.debet ELSE 0 END) AS total_piutang,
            SUM(CASE WHEN YEAR(b.tgl) < '$year' THEN a.debet ELSE 0 END) AS saldo_piutang,
            SUM(CASE WHEN MONTH(b.tgl) = 1 AND YEAR(b.tgl) >= '$year' THEN a.debet ELSE 0 END) AS januari_piutang,
            SUM(CASE WHEN MONTH(b.tgl) = 2 AND YEAR(b.tgl) >= '$year' THEN a.debet ELSE 0 END) AS februari_piutang,
            SUM(CASE WHEN MONTH(b.tgl) = 3 AND YEAR(b.tgl) >= '$year' THEN a.debet ELSE 0 END) AS maret_piutang,
            SUM(CASE WHEN MONTH(b.tgl) = 4 AND YEAR(b.tgl) >= '$year' THEN a.debet ELSE 0 END) AS april_piutang,
            SUM(CASE WHEN MONTH(b.tgl) = 5 AND YEAR(b.tgl) >= '$year' THEN a.debet ELSE 0 END) AS mei_piutang,
            SUM(CASE WHEN MONTH(b.tgl) = 6 AND YEAR(b.tgl) >= '$year' THEN a.debet ELSE 0 END) AS juni_piutang,
            SUM(CASE WHEN MONTH(b.tgl) = 7 AND YEAR(b.tgl) >= '$year' THEN a.debet ELSE 0 END) AS juli_piutang,
            SUM(CASE WHEN MONTH(b.tgl) = 8 AND YEAR(b.tgl) >= '$year' THEN a.debet ELSE 0 END) AS agustus_piutang,
            SUM(CASE WHEN MONTH(b.tgl) = 9 AND YEAR(b.tgl) >= '$year' THEN a.debet ELSE 0 END) AS september_piutang,
            SUM(CASE WHEN MONTH(b.tgl) = 10 AND YEAR(b.tgl) >= '$year' THEN a.debet ELSE 0 END) AS oktober_piutang,
            SUM(CASE WHEN MONTH(b.tgl) = 11 AND YEAR(b.tgl) >= '$year' THEN a.debet ELSE 0 END) AS november_piutang,
            SUM(CASE WHEN MONTH(b.tgl) = 12 AND YEAR(b.tgl) >= '$year' THEN a.debet ELSE 0 END) AS december_piutang
        ...
        SELECT 
            ...
            SUM(CASE WHEN YEAR(b.tgl) < '$year' THEN a.kredit ELSE 0 END) AS saldo_pembayaran,
            SUM(CASE WHEN MONTH(b.tgl) = 1 AND YEAR(b.tgl) >= '$year' THEN a.kredit ELSE 0 END) AS januari_pembayaran,
            SUM(CASE WHEN MONTH(b.tgl) = 2 AND YEAR(b.tgl) >= '$year' THEN a.kredit ELSE 0 END) AS februari_pembayaran,
            SUM(CASE WHEN MONTH(b.tgl) = 3 AND YEAR(b.tgl) >= '$year' THEN a.kredit ELSE 0 END) AS maret_pembayaran,
            SUM(CASE WHEN MONTH(b.tgl) = 4 AND YEAR(b.tgl) >= '$year' THEN a.kredit ELSE 0 END) AS april_pembayaran,
            SUM(CASE WHEN MONTH(b.tgl) = 5 AND YEAR(b.tgl) >= '$year' THEN a.kredit ELSE 0 END) AS mei_pembayaran,
            SUM(CASE WHEN MONTH(b.tgl) = 6 AND YEAR(b.tgl) >= '$year' THEN a.kredit ELSE 0 END) AS juni_pembayaran,
            SUM(CASE WHEN MONTH(b.tgl) = 7 AND YEAR(b.tgl) >= '$year' THEN a.kredit ELSE 0 END) AS juli_pembayaran,
            SUM(CASE WHEN MONTH(b.tgl) = 8 AND YEAR(b.tgl) >= '$year' THEN a.kredit ELSE 0 END) AS agustus_pembayaran,
            SUM(CASE WHEN MONTH(b.tgl) = 9 AND YEAR(b.tgl) >= '$year' THEN a.kredit ELSE 0 END) AS september_pembayaran,
            SUM(CASE WHEN MONTH(b.tgl) = 10 AND YEAR(b.tgl) >= '$year' THEN a.kredit ELSE 0 END) AS oktober_pembayaran,
            SUM(CASE WHEN MONTH(b.tgl) = 11 AND YEAR(b.tgl) >= '$year' THEN a.kredit ELSE 0 END) AS november_pembayaran,
            SUM(CASE WHEN MONTH(b.tgl) = 12 AND YEAR(b.tgl) >= '$year' THEN a.kredit ELSE 0 END) AS december_pembayaran
        FROM jurnal_detail a LEFT JOIN jurnal b ON a.id_parent=b.id
        WHERE a.nama_akun LIKE 'Piutang%' 
            AND a.debet = 0 
            AND a.deleted = 0 
