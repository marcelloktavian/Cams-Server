...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <div id="right" align='right'><?= rupiah($data['subtotal']) ?></div>
    ...
    <tr>
      ...
      <td class='style_detail'>
        <div id="container" >
        <div id="left3">UTANG DIBAYAR DIMUKA

</div>
        <div id="right3" align='right'><&nbsp;</div>
      </div>
    </td>
    <td colspan='1'><div class='style_detail'>PEMBAYARAN UTANG</div></td>
    ...
    <td class='style_detail2'> <div id="container"><u>UTANG DIBAYAR DIMUKA</u><br><div id="left2">SUBTOTAL : RP.</div><div id="right2" align="right"><?= rupiah($ppn) ?></div></div></td>
    </tr>
  <?php } ?>
