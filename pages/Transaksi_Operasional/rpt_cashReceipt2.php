...
<?php
    ...
    $sql = "SELECT det.uraian, det.buktikas, det.no_akun, det.nama_akun, det.debet, det.kredit, mst.total_debet, mst.total_kredit, IF(mst.kode='','0',mst.kode) as kode, IF(mst.kasbon2='','0',mst.kasbon2) as kasbon2
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr>
        <td colspan=5 class="style19" align="center">LAPORAN KAS HARIAN</td>
    </tr>
    <tr>
        <td colspan=5 class="style10" align="center"><div style="text-transform:uppercase">TANGGAL : <?=date_format($date2,"d F Y")?></div></td>
    </tr>
    <tr>
        <td colspan=5>&nbsp;</td>
    </tr>
    ...
    <?php
        ...
        while ($data = mysql_fetch_array($result)){
          ...
          $kasbon2 = $data['kasbon2'];
            ...
            <tr><?php
              if($jumlah == 1){
                ?><td class='style_detail_left'><div  align="right"><font style="color:white;">.</font></div></td>
                 <td  class='style_detail'><div style='text-decoration: underline;text-underline-position: under;'><?=$data['uraian']?></div></td>
                <?php
              }else{
                ?><td class='style_detail_left'><div  align="right"><?=$no?></div></td>
                 <td class='style_detail'><div><?=$data['uraian']?></div></td>
                 <?php
              }
              if($data['buktikas'] == ''){
                ?><td  class='style_detail'><div align="center"><font style="color:white;">.</font></div></td><?php
              }else{
                ?><td  class='style_detail'><div align="center"><?=$data['buktikas']?></div></td><?php
              }

              if($data['debet'] == '' || $data['debet']=='0'){
                ?><td  class='style_detail'><div align="right"><font style="color:white;">.</font></div></td><?php
              }else{
                ?><td  class='style_detail'><div align='right'><?=number_format($data['debet'],0)?></div></td><?php
                if($jumlah > 1){
              ...
              if($data['kredit'] == '' || $data['kredit']=='0'){
                ...
                ?><td  class='style_detail'><div align='right'><?=number_format($data['kredit'],0)?></div></td><?php
              }
            ?>
            </tr>
            <?php
            ...
            if($jumlah == 1){
              ...
              <tr>
                <td class='style_detail_left'><div  align="right"><font style="color:white;">.</font></div></td>
                <td  class='style_detail'><div align="center"><font style="color:white;">.</font></div></td>
                <td  class='style_detail'><div align="center"><font style="color:white;">.</font></div></td>
                <td  class='style_detail'><div align="center"><font style="color:white;">.</font></div></td>
                <td  class='style_detail'><div align="center"><font style="color:white;">.</font></div></td>
              </tr>
    ...
    ?>
    <tr>
        <td class='style_detail_left'><div >&nbsp;</div></td>
        <td class='style_detail'><div>&nbsp;</div></td>
        <td class='style_detail'><div>&nbsp;</div></td>
        <td  class='style_detail'><div style='border-top: 1px solid black;' align='right'><?=number_format($totdebettnpsaldo,0)?></div></td>
        <td  class='style_detail'><div style='border-top: 1px solid black;' align='right'><?=number_format($totkredit,0)?></div></td>
    </tr>
    <tr>
        <td class='style_detail_left'><div >&nbsp;</div></td>
        <td  class='style_detail'><div align='center'>Saldo Per : <?=date_format($date2,"d M Y")?></div></td>
        <td class='style_detail'><div>&nbsp;</div></td>
        <td class='style_detail'><div>&nbsp;</div></td>
        <td  class='style_detail'><div align='right'><?=number_format($totdebet-$totkredit,0)?></div></td>
    </tr>
    <tr>
        <td class='style_detail_left'><div ></div></td>
        <td class='style_detail'><div></div></td>
    ...
    <tr>
        <td class='style_detail_left' style='border-bottom: 1px solid black;'><div  >&nbsp;</div></td>
        <td  class='style_detail' style='border-bottom: 1px solid black;'><div align='center' >J U M L A H :</div></td>
        <td  class='style_detail' style='border-bottom: 1px solid black;'><div >&nbsp;</div></td>
        <td  class='style_detail' style='border-bottom: 1px solid black;'><div  align='right'><?=number_format($totdebet,0)?></div></td>
        <td  class='style_detail' style='border-bottom: 1px solid black;'><div  align='right'><?=number_format($totkredit+($totdebet-$totkredit),0)?></div></td>
    </tr>
    <tr>
        <td colspan=5>&nbsp;</td>
    </tr>
    ...
    <tr>
        ...
        <td align='right'><div class='font'><?=number_format((($totdebet-$totkredit)-$kasbon)-$kasbon2,0)?></div></td>
    ...
    <tr>
        ...
        <td align='right'><div class='font'><?=number_format($kasbon2,0)?></div></td>
        <td style='padding:13px;'></td>
        <td></td>
    </tr>
</table>
