...
<?php
    ...
    $sql = "SELECT det.uraian, det.buktikas, det.no_akun, det.nama_akun, det.debet, det.kredit, mst.total_debet, mst.total_kredit, mst.kode
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr>
        ...
        <td><div class='style_detail' style='border-bottom: 1px solid black;' align='right'><?=number_format($totdebet,0)?></div></td>
    ...
    <tr>
        ...
        <td align='right'><div class='font'><?=number_format(($totdebet-$totkredit)-$kasbon,0)?></div></td>
