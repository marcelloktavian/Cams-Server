...
echo"<form id='form2' name='form2' action='' method='post'>
    <table width='100%'>
  	<tr>
    	<td  class='fontjudul'>ADD PAYMENT CHECK</td>
		<td class='fontjudul'> TOTAL PAYMENT <input type='text' class='' name='totalcsv' id='totalcsv' style='text-align:right;font-size: 30px;background-color:white;height:40px;border:1px dotted #f30; border-radius:4px; -moz-border-radius:4px;' value='Rp 0,00' />
		<input type='hidden' name='totalcsvhidden' id='totalcsvhidden'/>
		<td class='fontjudul'> TOTAL SALES <input type='text' class='' name='totaloln' id='totaloln' style='text-align:right;font-size: 30px;background-color:white;height:40px;border:1px dotted #f30; border-radius:4px; -moz-border-radius:4px;' value='Rp 0,00' />
		<input type='hidden' name='totalolnhidden' id='totalolnhidden'/>
		...
		<input type='hidden' name='totalsisahidden' id='totalsisahidden'/>
		</td>
    </tr>
</table>
    <hr />
<table width='100%' cellspacing='0' cellpadding='0' border=0>
	...
	<td><input type='date'  id='tglcheck' name='tglcheck' class='datepicker' value='".date('Y-m-d')."'><button type='button' id='generate'>Generate</td>  
	</td>   
	<td class='fonttext'>Note</td>
        <td rowspan=1><textarea name='note' id='note' cols='60' rows='3'></textarea></td>
	</tr>
     <tr height='1'>
     <td colspan='4'></td>
     </tr>
