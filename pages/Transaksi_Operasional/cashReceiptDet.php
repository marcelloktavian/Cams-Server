...
<form id='form2' name='form2' action='' method='post'>
    <table width='100%'>
  	<tr>
		...
		<input type='text' class='' name='debet_m' id='debet_m' value='0' style='text-align:right;font-size: 30px;background-color:white;width: 300px;height:40px;border:1px dotted #f30; border-radius:4px; -moz-border-radius:4px;' />
		<!-- debet hidden -->
		<input type="hidden" name="debet" id="debet">

        <!-- Kredit -->
        <td class='fontjudul'> Kredit <input type='text' class='' name='kredit_m' id='kredit_m' value='0' style='text-align:right;font-size: 30px;background-color:white;width: 300px;height:40px;border:1px dotted #f30; border-radius:4px; -moz-border-radius:4px;' />
		<!-- Kredit hidden -->
...
<table width='100%' cellspacing='0' cellpadding='0'>
	<tr>
        ...
        <td><input type='text' class='inputform' name='kode' id='kode' placeholder='Kas Bon 1' value='' />
        </td>
		<td class="fonttext">Kas Bon 2</td>
        <td><input type='text' class='inputform' name='kode2' id='kode2' placeholder='Kas Bon 2' value='' />
        </td>
    ...
    <tr>
        ...
        <td ><textarea  name="txtbrg" id="txtbrg" cols="50" rows="2" placeholder="Keterangan"></textarea></td>
    </tr>
     <tr height='5'>
     <td colspan='6'></td>
     </tr>
...
<thead>
    <tr>
        ...
        <input type="text" name="debet_total" id="debet_total" size="20"  style="text-align: right;" disabled value='0'></td>
		<td align='center' width='10%' class='fonttext'><input type="hidden" name="kredit_tot" id="kredit_tot">
        <input type="text" name="kredit_total" id="kredit_total" size="20"  style="text-align: right;" disabled value='0'></td>
...
function cetak(){
	...
	{	var answer = confirm("Mau Simpan datanya????")
		...
		hitungrow();
		// hitung() ;
		document.form2.action="simpancashReceipt.php?trans=INSERT";
