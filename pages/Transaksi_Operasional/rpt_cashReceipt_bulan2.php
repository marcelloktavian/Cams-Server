        ...
        <tr>
          <br>
            ...
            <tr>
                ...
                <td width='49%'><div class="style_title" style="border-top: 1px solid black;" align='center' >URAIAN</div></td>
                <td width='20%'><div class="style_title" style="border-top: 1px solid black;" align='center' >BUKTI KAS</div></td>
          ...
          if($tgl2 != $tgl && $jumlah != '1'){
            ...
            if(fmod($totalbaris,38)==0 && $jumlah != '1'){
              ?>
                <tr>
                <tr><td class='style_detail_up' colspan='5' ></td></tr>
