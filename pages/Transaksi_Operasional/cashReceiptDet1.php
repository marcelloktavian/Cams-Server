...
<table width='100%' cellspacing='0' cellpadding='0'>
	<tr>
		<td class="fonttext">Kas Bon</td>
        <td><input type='text' class='inputform' name='kode' id='kode' placeholder='Kas Bon' value='' />
        </td>
        <td rowspawn=2 class="fonttext">Keterangan</td>
        <td rowspawn=2><textarea  name="txtbrg" id="txtbrg" cols="50" rows="3"></textarea></td>
    </tr>
    <tr>
