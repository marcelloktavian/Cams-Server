...
<table width='100%' cellspacing='0' cellpadding='0'>
	<tr>
        ...
        <td><input type='text' class='inputform' name='kode' id='kode' placeholder='Kas Bon' value='<?=$data['kode']?>' />
        </td>
        <td rowspawn=2 class="fonttext">Keterangan</td>
        <td rowspawn=2><textarea  name="txtbrg" id="txtbrg" cols="50" rows="3"><?=$data['keterangan']?></textarea></td>
    </tr>
    <tr>
