  ...
  $(document).ready(function(){
    ...
    $('#table_purchproducts').jqGrid({
      ...
      colModel  : [
        ...
        {name:'b.vendor', index:'b.vendor', searchoptions: {sopt:['cn']}},
        ...
        {name:'nomor_akun', index:'nomor_akun', align:'center', searchoptions: {sopt:['cn']}},
        {name:'c.nama', index:'c.nama', align:'left', searchoptions: {sopt:['cn']}},
