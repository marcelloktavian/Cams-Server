...
<body>	
		<table border ="1px">
            ...
            WHERE jurnal.keterangan LIKE '%Penjualan B2B%'");
			while($d = mysql_fetch_array($data)){
                ...
                WHERE nama_akun LIKE '%Penjualan B2B%' AND id_parent='".$d['id']."' ");
	...
	<table border ="1px">
			<thead>
                <tr>
                    <th colspan='8'>DATA PENJUALAN B2B CANCELLED</th>
                </tr>
				<tr>
					<th class="text-left">No.</th>
					<th class="text-left">ID</th>
            ...
            WHERE jurnal.keterangan LIKE '%CANCELLED B2B%'");
			while($d = mysql_fetch_array($data)){
				?>
				<tr>
					<td class="text-left"><?php echo $no; ?></td>
