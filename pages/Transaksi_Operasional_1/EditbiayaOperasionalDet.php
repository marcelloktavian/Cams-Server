...
<form id='form2' name='form2' action='' method='post'>
    <table width='100%'>
  	<tr>
		...
		<input type='text' class='' name='subtotal_m' id='subtotal_m' value='<?php echo $data['subtotal'] ?>' style='text-align:right;font-size: 30px;background-color:white;width: 300px;height:40px;border:1px dotted #f30; border-radius:4px; -moz-border-radius:4px;' />
		<!-- subtotal hidden -->
		<input type="hidden" name="subtotal" id="subtotal" value="<?php echo $data['subtotal'] ?>">
		<!--  ppn -->
        <td class='fontjudul'> PPN
		<input type='text' class='' name='PPN_m' id='PPN_m' value='<?php echo $data['ppn'] ?>' style='text-align:right;font-size: 30px;background-color:white;width: 300px;height:40px;border:1px dotted #f30; border-radius:4px; -moz-border-radius:4px;' />
		<!-- ppn hidden -->
		<input type="hidden" name="PPN" id="PPN" value="<?php echo $data['ppn'] ?>">
		 <!-- grandtotal -->
        <td class='fontjudul'> TOTAL <input type='text' class='' name='grandtotal_m' id='grandtotal_m' value='<?php echo $data['total'] ?>' style='text-align:right;font-size: 30px;background-color:white;width: 300px;height:40px;border:1px dotted #f30; border-radius:4px; -moz-border-radius:4px;' />
		<!-- grandtotal hidden -->
...
<?php 
$sqldetail = $db->prepare("SELECT * FROM biayaoperasional_det where id_parent=?");
...
document.getElementById('idbiaya'+<?=$i;?>+'').value = '<?=$result['id_biaya'];?>';
document.getElementById('BARCODE'+<?=$i;?>+'').value = '<?=$result['id_biaya'];?>';
document.getElementById('namabiaya'+<?=$i;?>+'').value = '<?=$result['namabiaya'];?>';
document.getElementById('packing'+<?=$i;?>+'').value = '<?=$result['satuan'];?>';
document.getElementById('Qty'+<?=$i;?>+'').value = '<?=$result['qty'];?>';
document.getElementById('hargaSatuan'+<?=$i;?>+'').value = '<?=$result['harga_satuan'];?>';
document.getElementById('Subtotal'+<?=$i;?>+'').value = '<?=$result['jumlah'];?>';
<?php 
$i++;
}
?>
