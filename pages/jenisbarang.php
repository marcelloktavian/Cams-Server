...
//--------------end of searching--------------------		
        ...
        foreach($data1 as $line) {
			...
			if(in_array($_SESSION['user']['access'], $allowEdit))
				$edit = '<a onclick="javascript:popup_form(\''.BASE_URL.'pages/jenisbarang.php?action=edit&id='.$line['id'].'\',\'table_jenisbarang\')" href="javascript:;">Edit</a>';
			else
				$edit = '<a onclick="javascript:custom_alert(\'Not Allowed\')" href="javascript:;">Edit</a>';
        	
			if(in_array($_SESSION['user']['access'], $allowDelete))
				$delete = '<a onclick="javascript:link_ajax(\''.BASE_URL.'pages/jenisbarang.php?action=delete&id='.$line['id'].'\',\'table_jenisbarang\')" href="javascript:;">Delete</a>';
			else
...
<?php
	...
	if(in_array($_SESSION['user']['access'], $allow)) {
		echo '<button type="button" onclick="javascript:popup_form(\''.BASE_URL.'pages/jenisbarang.php?action=add\',\'table_jenisbarang\')" class="btn">Tambah</button>';
	}
?>
</div>
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $("#table_jenisbarang").jqGrid({
            url:'<?php echo BASE_URL.'pages/jenisbarang.php?action=json'; ?>',
            /*postData: {
