...
<form id="form2" name="form2" action="" method="post"  onSubmit="return validasi(this)">
  ...
  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
	...
	//$id_faktur=TSO18020021;
	$sq2 = mysql_query("select b.namaperusahaan,a.id_trans,a.kode, date_format(a.tgl_trans,'%d-%m-%Y') as tgl_trans, a.totalqty,a.faktur, a.totalfaktur, a.tunai,a.transfer,a.piutang,a.biaya from trjual a left join tblpelanggan b on b.id = a.id_customer
