...
<form id="form2" name="form2" action="" method="post"  onSubmit="return validasi(this)">
  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr>
      <td height="123" valign="top"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>  
		  <td width="19%" class="style9"><a href="report_jualxl.php?start=<?php echo"".$tglstart;?>&end=<?php echo"".$tglend;?>">Export ke Excell</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Dari</td>
  ...
  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
	...
	//$id_faktur=TSO18020021;
	$sq2 = mysql_query("select b.namaperusahaan,a.id_trans,a.kode, date_format(a.tgl_trans,'%d-%m-%Y') as tgl_trans, a.totalqty,a.faktur, a.totalfaktur,b.id_cust, a.tunai,a.transfer,a.piutang,a.biaya from trjual a left join tblpelanggan b on b.id = a.id_customer
	where DATE_FORMAT(a.tgl_trans,'%Y-%m-%d') between '".$tglstart."' AND '" .$tglend."' order by a.id_trans asc");
//	"2017-06-15", "%M %d %Y"
