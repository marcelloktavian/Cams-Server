...
<form id="form2" name="form2" action="" method="post"  onSubmit="return validasi(this)">
  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr>
      <td height="123" valign="top"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td width="50%" class="style99" colspan="6"><strong>LAPORAN TRANSAKSI PELUNASAN PIUTANG TOKO</strong></td>
  ...
  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr>
      ...
      <td width="10%" class="style9b"><div align="center">Tanggal</div></td>
 	  <td width="10%" class="style9b"><div align="left">No.Kwitansi</div></td>
      <td width="25%" class="style9b"><div align="left">Pelanggan</div></td>
	...
	//$id_faktur=TSO18020021;
	$sq2 = mysql_query("select b.namaperusahaan,a.id_trans, date_format(a.tgl_trans,'%d-%m-%Y') as tgl_trans, a.totalqty, a.totalfaktur, a.tunai,a.transfer from trpiutang a left join tblpelanggan b on b.id = a.id_customer
	where DATE_FORMAT(a.tgl_trans,'%Y-%m-%d') between '".$tglstart."' AND '" .$tglend."'");
//	"2017-06-15", "%M %d %Y"
