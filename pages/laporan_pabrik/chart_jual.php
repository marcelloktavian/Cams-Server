<<?php
$koneksi     = mysqli_connect("localhost", "root", "", "sbsys");
$bulan       = mysqli_query($koneksi, "SELECT bulan FROM pen
jualan WHERE tahun='2016' order by id asc");
$penghasilan = mysqli_query($koneksi, "SELECT hasil_penjualan FROM penjualan WHERE tahun='2016' order by id asc");
?>
<html>
    <head>
        <title>Grafik Chart Penjualan</title>
