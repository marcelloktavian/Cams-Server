...
<form id="form2" name="form2" action="" method="post"  onSubmit="return validasi(this)">
  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr>
      <td height="123" valign="top"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td width="50%" class="style99" colspan="6"><strong><a href="javascript:window.print()">CETAK</a> LAPORAN TRANSAKSI PELUNASAN PIUTANG TOKO</strong></td>
  ...
  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
	...
	//$id_faktur=TSO18020021;
	$sq2 = mysql_query("select b.namaperusahaan,a.id_trans,pd.faktur,pd.piutang,pd.piutang_update,(pd.piutang-pd.piutang_update) as angsuran,a.id_transjual, date_format(a.tgl_trans,'%d-%m-%Y') as tgl_trans, a.totalqty, a.totalfaktur, a.tunai,a.transfer from trpiutang a left join tblpelanggan b on b.id = a.id_customer inner join trpiutang_detail pd on a.id_trans=pd.id_trans where DATE_FORMAT(a.tgl_trans,'%Y-%m-%d') between '".$tglstart."' AND '" .$tglend."'");
//	"2017-06-15", "%M %d %Y"
  ...
  ?>
    <tr>
      ...
      <td class="style9"><?=$rs2['id_trans'];?></td>
      <td class="style9">
		<div align="center">
		<?=$rs2['namaperusahaan'];?>
		</div>
