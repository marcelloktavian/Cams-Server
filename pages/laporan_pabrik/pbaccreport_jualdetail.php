...
<form id="form2" name="form2" action="" method="post"  onSubmit="return validasi(this)">
  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr>
      <td height="123" valign="top"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td width="19%" class="style9"><a href="pbaccreport_jualdetailxl.php?start=<?php echo"".$tglstart;?>&end=<?php echo"".$tglend;?>&id=<?php echo"".$id_pelanggan;?>">Export ke Excell</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Dari</td>
  ...
  ?>
    <tr>
	  <!-- Bikin Master No-->
	  <?
	  if ($kode_no!=$rs2['id_trans'])
	  {
		echo"<td class='style9'><span class='style9'>".$nomer."</span></td>";
		$kode_no=$rs2['id_trans'];
		$nomer++;
	  
	  }
      else if($kode_no=$rs2['id_trans'])
	  {
	  echo"<td class='style9'><span class='style9'></span></td>";
	  }
	  ?>
	  <!--
  ...
  ?>
	...
	<td class="style9"><div align="right">
          <?=number_format($totaldpp*$konversi_yard*0.11,0);//totalppn?>
    </div>
	</td>
