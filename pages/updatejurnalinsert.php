...
<body>	
		<table border ="1px">
			<thead>
                <tr>
                    <th colspan='8'>DATA PENJUALAN CASH TGL 1 JANUARI 2023</th>
                </tr>
				<tr>
			...
			$data = mysql_query("SELECT olnso.id_trans, olnso.total, olnso.transfer, olnso.deposit, olnso.id_dropshipper,mst_dropshipper.nama, date(olnso.lastmodified) as tgl, ROUND(total/1.11) AS dpp, ROUND(total/1.11*0.11) AS ppn, olnso.lastmodified, olnso.id FROM olnso LEFT JOIN mst_dropshipper ON mst_dropshipper.id=olnso.id_dropshipper WHERE DATE(olnso.lastmodified) = '2023-01-01' AND piutang = 0");
			while($d = mysql_fetch_array($data)){
				...
				$masterNo = '';
					...
					FROM jurnal WHERE DATE(tgl) = '2023-01-01' ORDER BY id DESC LIMIT 1"));
				$masterNo='230101'.$q['nomor'];
	...
	<table border ="1px">
			<thead>
                <tr>
                    <th colspan='8'>DATA PENJUALAN CASH TGL 2 JANUARI 2023</th>
                </tr>
				<tr>
					<th class="text-left">No.</th>
					<th class="text-left">ID</th>
			...
			$data = mysql_query("SELECT olnso.id_trans, olnso.total, olnso.transfer, olnso.deposit, olnso.id_dropshipper,mst_dropshipper.nama, date(olnso.lastmodified) as tgl, ROUND(total/1.11) AS dpp, ROUND(total/1.11*0.11) AS ppn, olnso.lastmodified, olnso.id FROM olnso LEFT JOIN mst_dropshipper ON mst_dropshipper.id=olnso.id_dropshipper WHERE DATE(olnso.lastmodified) = '2023-01-02' AND piutang = 0");
			while($d = mysql_fetch_array($data)){
				$idtrans=$d['id_trans'];
				$transfer=$d['transfer'];
				$deposit=$d['deposit'];
				...
				$masterNo = '';
					$q = mysql_fetch_array( mysql_query("SELECT IF(LENGTH(RIGHT(no_jurnal, 5)+1) = 1, CONCAT('0000',(RIGHT(no_jurnal, 5)+1)), IF(LENGTH(RIGHT(no_jurnal, 5)+1) = 2, 
					CONCAT('000',(RIGHT(no_jurnal, 5)+1)), IF(LENGTH(RIGHT(no_jurnal, 5)+1) = 3,CONCAT('00',(RIGHT(no_jurnal, 5)+1)), IF(LENGTH(RIGHT(no_jurnal, 5)+1) = 4,CONCAT('0',(RIGHT(no_jurnal, 5)+1)), CONCAT('',(RIGHT(no_jurnal, 5)+1))) ) ) ) AS nomor 
					FROM jurnal WHERE DATE(tgl) = '2023-01-02' ORDER BY id DESC LIMIT 1"));
				$masterNo='230102'.$q['nomor'];
	...
	<table border ="1px">
			<thead>
                <tr>
                    <th colspan='8'>DATA PENJUALAN CASH TGL 3 JANUARI 2023</th>
                </tr>
				<tr>
					<th class="text-left">No.</th>
					<th class="text-left">ID</th>
			...
			$data = mysql_query("SELECT olnso.id_trans, olnso.total, olnso.transfer, olnso.deposit, olnso.id_dropshipper,mst_dropshipper.nama, date(olnso.lastmodified) as tgl, ROUND(total/1.11) AS dpp, ROUND(total/1.11*0.11) AS ppn, olnso.lastmodified, olnso.id FROM olnso LEFT JOIN mst_dropshipper ON mst_dropshipper.id=olnso.id_dropshipper WHERE DATE(olnso.lastmodified) = '2023-01-03' AND piutang = 0");
			while($d = mysql_fetch_array($data)){
				$idtrans=$d['id_trans'];
				$transfer=$d['transfer'];
				$deposit=$d['deposit'];
				...
				$masterNo = '';
					$q = mysql_fetch_array( mysql_query("SELECT IF(LENGTH(RIGHT(no_jurnal, 5)+1) = 1, CONCAT('0000',(RIGHT(no_jurnal, 5)+1)), IF(LENGTH(RIGHT(no_jurnal, 5)+1) = 2, 
					CONCAT('000',(RIGHT(no_jurnal, 5)+1)), IF(LENGTH(RIGHT(no_jurnal, 5)+1) = 3,CONCAT('00',(RIGHT(no_jurnal, 5)+1)), IF(LENGTH(RIGHT(no_jurnal, 5)+1) = 4,CONCAT('0',(RIGHT(no_jurnal, 5)+1)), CONCAT('',(RIGHT(no_jurnal, 5)+1))) ) ) ) AS nomor 
					FROM jurnal WHERE DATE(tgl) = '2023-01-03' ORDER BY id DESC LIMIT 1"));
				$masterNo='230103'.$q['nomor'];
	...
	<table border ="1px">
			<thead>
                <tr>
                    <th colspan='8'>DATA PENJUALAN CASH TGL 4 JANUARI 2023</th>
                </tr>
				<tr>
					<th class="text-left">No.</th>
					<th class="text-left">ID</th>
			...
			$data = mysql_query("SELECT olnso.id_trans, olnso.total, olnso.transfer, olnso.deposit, olnso.id_dropshipper,mst_dropshipper.nama, date(olnso.lastmodified) as tgl, ROUND(total/1.11) AS dpp, ROUND(ROUND(total/1.11)*0.11) AS ppn, olnso.lastmodified, olnso.id FROM olnso LEFT JOIN mst_dropshipper ON mst_dropshipper.id=olnso.id_dropshipper WHERE DATE(olnso.lastmodified) = '2023-01-04' AND piutang = 0");
			while($d = mysql_fetch_array($data)){
				$idtrans=$d['id_trans'];
				$transfer=$d['transfer'];
				$deposit=$d['deposit'];
				...
				$masterNo = '';
					$q = mysql_fetch_array( mysql_query("SELECT IF(LENGTH(RIGHT(no_jurnal, 5)+1) = 1, CONCAT('0000',(RIGHT(no_jurnal, 5)+1)), IF(LENGTH(RIGHT(no_jurnal, 5)+1) = 2, 
					CONCAT('000',(RIGHT(no_jurnal, 5)+1)), IF(LENGTH(RIGHT(no_jurnal, 5)+1) = 3,CONCAT('00',(RIGHT(no_jurnal, 5)+1)), IF(LENGTH(RIGHT(no_jurnal, 5)+1) = 4,CONCAT('0',(RIGHT(no_jurnal, 5)+1)), CONCAT('',(RIGHT(no_jurnal, 5)+1))) ) ) ) AS nomor 
					FROM jurnal WHERE DATE(tgl) = '2023-01-04' ORDER BY id DESC LIMIT 1"));
				$masterNo='230104'.$q['nomor'];
	...
	<table border ="1px">
			<thead>
                <tr>
                    <th colspan='8'>DATA PENJUALAN CASH TGL 5 JANUARI 2023</th>
                </tr>
				<tr>
					<th class="text-left">No.</th>
					<th class="text-left">ID</th>
			...
			$data = mysql_query("SELECT olnso.id_trans, olnso.total, olnso.transfer, olnso.deposit, olnso.id_dropshipper,mst_dropshipper.nama, date(olnso.lastmodified) as tgl, ROUND(total/1.11) AS dpp, ROUND(ROUND(total/1.11)*0.11) AS ppn, olnso.lastmodified, olnso.id FROM olnso LEFT JOIN mst_dropshipper ON mst_dropshipper.id=olnso.id_dropshipper WHERE DATE(olnso.lastmodified) = '2023-01-05' AND piutang = 0");
			while($d = mysql_fetch_array($data)){
				$idtrans=$d['id_trans'];
				$transfer=$d['transfer'];
				$deposit=$d['deposit'];
				...
				$masterNo = '';
					$q = mysql_fetch_array( mysql_query("SELECT IF(LENGTH(RIGHT(no_jurnal, 5)+1) = 1, CONCAT('0000',(RIGHT(no_jurnal, 5)+1)), IF(LENGTH(RIGHT(no_jurnal, 5)+1) = 2, 
					CONCAT('000',(RIGHT(no_jurnal, 5)+1)), IF(LENGTH(RIGHT(no_jurnal, 5)+1) = 3,CONCAT('00',(RIGHT(no_jurnal, 5)+1)), IF(LENGTH(RIGHT(no_jurnal, 5)+1) = 4,CONCAT('0',(RIGHT(no_jurnal, 5)+1)), CONCAT('',(RIGHT(no_jurnal, 5)+1))) ) ) ) AS nomor 
					FROM jurnal WHERE DATE(tgl) = '2023-01-05' ORDER BY id DESC LIMIT 1"));
				$masterNo='230105'.$q['nomor'];
