	...
	<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
		<tr>
			...
			<th width="15%" class="style_title">
				<div align="right">Total Faktur</div>
				</td>
			<th width="15%" class="style_title">
				<div align="right">Total Ongkir</div>
				</td>
			<th width="15%" class="style_title">
				<div align="right">Total Disc</div>
				</td>
			<th width="15%" class="style_title">
				<div align="right">Faktur+Ongkir-Disc</div>
				</td>
        ...
        FROM b2bdo m 
        LEFT JOIN mst_b2bcustomer sls ON sls.id=m.id_customer " . $where . "
		...
		?>
			<tr>
				<td class="style_detail_left">
					<div align="left"><?= $nomer; ?>
					</div>
				</td>
				<td class="style_detail">
					<div align="left"><?= $rs2['salesman']; ?>
					</div>
				</td>
				<td class="style_detail">
				...
				<td class="style_detail">
					<div align="center"><?= number_format($rs2['jum_order']); ?></div>
				</td>
				<td class="style_detail">
					<div align="right"><?= number_format($rs2['faktur']); ?></div>
				</td>
				<td class="style_detail">
					<div align="right"><?= number_format($rs2['ongkir']); ?></div>
				</td>
				<td class="style_detail">
					<div align="right"><?= number_format($rs2['disc']); ?></div>
				</td>
				<td class="style_detail">
					<div align="right"><?= number_format($rs2['faktur'] + $rs2['ongkir'] - $rs2['disc']); ?>
					</div>
				</td>
			</tr> <?
		...
		<tr>
			...
			<td class="style_footer">
				<div align="center"><?= number_format($grand_order); ?></div>
			</td>
			<td class="style_footer">
				<div align="right"><?= number_format($grand_faktur); ?></div>
			</td>
			<td class="style_footer">
		...
		<tr>
			<td class="style_footer" colspan="7">
				<div align="right">Nett Faktur :</div>
			</td>
			<td class="style_footer">
				<div align="right"><?= number_format($grand_faktur); ?></div>
			</td>
		...
		<tr>
			...
			<td class="style_footer">
				<div align="right"><?= number_format($dpp); ?></div>
			</td>
		</tr>
		<tr>
			<td class="style_footer" colspan="7">
			...
			<td class="style_footer">
				<div align="right"><?= number_format($dpp * 0.11); ?></div>
			</td>
		</tr>
