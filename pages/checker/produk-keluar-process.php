...
<center>
  ...
  foreach($data as $line){
    $query = mysql_query("SELECT COALESCE(SUM('a.namabrg'),0) AS total_barang FROM olnsodetail a LEFT JOIN olnso b ON a.id_trans=b.id_trans WHERE a.namabrg = '".$line['nama']."' AND b.lastmodified = '".$_POST['tanggalolnso']."' GROUP BY a.namabrg");
