...
$allow_add = is_show_menu(ADD_POLICY, Expedition, $group_acess);
$allow_edit = is_show_menu(EDIT_POLICY, Expedition, $group_acess);
$allow_delete = is_show_menu(DELETE_POLICY, Expedition, $group_acess);
