...
<table width='100%'>
<tr>
    <td class='fontjudul'>ADD COST</td>
</tr>
</table>
...
<table width='100%' cellspacing='0' cellpadding='0'>
     ...
     <tr>
		 ...
		 <td><input type='text' class='inputform' name='nama' id='nama' 	placeholder='Type'  /> </td>
	 </tr>
...
<td colspan=6 align='left'><textarea name='txtbrg' id='txtbrg' cols='100' rows='3' ></textarea></td></td>
</tr>
</table>
...
function cetak(){
	...
	{ 
		...
		{	
		hitungrow() ;
		document.form2.action="jenisbiaya_save.php?row="+baris1;
