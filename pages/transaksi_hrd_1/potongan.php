	...
	if(isset($_GET['action']) && strtolower($_GET['action']) == 'json') {
        ...
        foreach($data1 as $line) {
            ...
            $responce['rows'][$i]['cell'] = array(
                ...
                number_format($line['total_potongan_variabel'],0),               
				$edit,
            );

			$grandtotal += $line['total_potongan_variabel'];
...
<script type="text/javascript">
	...
	$( "#start_potongan" ).datepicker( 'setDate', '<?php echo date('d/m/Y')?>' );
	$( "#end_potongan" ).datepicker( 'setDate', '<?php echo date('d/m/Y')?>' );
