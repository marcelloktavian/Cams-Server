...
<tr>
    <td class='fontjudul'>PENGGAJIAN DETAIL</td>
		...
		<td class='fontjudul'> TOTAL POTONGAN <input type='text' class='' name='totalpotongan' id='totalpotongan' value='Rp. 0' style='text-align:right;font-size: 30px;background-color:white;height:40px;border:1px dotted #f30; border-radius:4px; -moz-border-radius:4px;' />
...
function hitungtotal(){
	...
	var Subtotal=document.getElementById("Subtotal"+i+"");
	 ...
	 {   
	    if(document.getElementById("Subtotal"+i+"").value == "") {
			...
			totalpotongan += parseInt(0);
		}else{
			if(document.getElementById("Tipe"+i+"").value=='Pendapatan'){
				totalpendapatan += parseInt(document.getElementById("Subtotal"+i+"").value);
			}else{
				totalpotongan += parseInt(document.getElementById("Subtotal"+i+"").value);
			}
		}
	 }
		//else{}
	...
	total = parseInt(totalpendapatan) - parseInt(totalpotongan);
...
function cetak(){
		...
		{	
			...
			window.opener.document.getElementById("TotalPendapatan"+b+"").value = parseInt(window.opener.document.getElementById("TotalPendapatan"+b+"").value) - parseInt($('#totalpendapatanSebelumnya').val());
			window.opener.document.getElementById("TotalPendapatan"+b+"").value = parseInt(window.opener.document.getElementById("TotalPendapatan"+b+"").value)  + parseInt($('#totalpendapatanhidden').val());

			window.opener.document.getElementById("TotalPotongan"+b+"").value = parseInt(window.opener.document.getElementById("TotalPotongan"+b+"").value) - parseInt($('#totalpotonganSebelumnya').val());
			window.opener.document.getElementById("TotalPotongan"+b+"").value = parseInt(window.opener.document.getElementById("TotalPotongan"+b+"").value)  + parseInt($('#totalpotonganhidden').val());

			window.opener.document.getElementById("Total"+b+"").value = parseInt(window.opener.document.getElementById("Total"+b+"").value) - parseInt($('#totalSebelumnya').val());
			window.opener.document.getElementById("Total"+b+"").value = parseInt(window.opener.document.getElementById("Total"+b+"").value)  + parseInt($('#totalhidden').val());
