<?php
	...
	?>
<b>Kalkulator PPH 21 THR</b><br><br>
<form>
    Objek Pajak : <input type="text" name="op" id="op"><br>
    THR : <input type="text" name="thr" id="thr"><br>
...
if(isset($_GET['op'])){
    ...
    $jabatan = ($persenjabatan/100) * $opx12thr;
    if($jabatan > $biayajabatan){
        $jabatan = $biayajabatan;
    }
    ...
    echo "<br>";
    echo "Objek Pajak x 12 + THR = ".number_format($opx12thr);
    echo "<br>";
    echo "THR = ".number_format($thr);
    echo "<br>";
	...
	while($d = mysql_fetch_array($data)){
        if($d['id']==1){
            ...
            $pph21thr = ($d['maksvalue1'] * 1000000) * ($d['persen1']/100) + ($pkp-($d['maksvalue1'] * 1000000)) * ($d['persen2']/100);
            // echo "2";
        }else if($d['id']==3){
            //250 jt - 500 jt
            echo $d['persen1'].'% x '.number_format($d['maksvalue1'] * 1000000).' = '.number_format(($d['maksvalue1'] * 1000000) * ($d['persen1']/100));
            ...
            $pph21thr = ($d['maksvalue1'] * 1000000) * ($d['persen1']/100) + (($d['maksvalue2']-$d['maksvalue1']) * 1000000) * ($d['persen2']/100) + ($pkp-($d['maksvalue2'] * 1000000)) * ($d['persen3']/100);
            // echo "3";
        }else if($d['id']==4){
            //500 jt - 5 M
            echo $d['persen1'].'% x '.number_format($d['maksvalue1'] * 1000000).' = '.number_format(($d['maksvalue1'] * 1000000) * ($d['persen1']/100));
            ...
            $pph21thr = ($d['maksvalue1'] * 1000000) * ($d['persen1']/100) + (($d['maksvalue2']-$d['maksvalue1']) * 1000000) * ($d['persen2']/100) + (($d['maksvalue3']-$d['maksvalue2']) * 1000000) * ($d['persen3']/100) + ($pkp-($d['maksvalue3'] * 1000000)) * ($d['persen4']/100);
            // echo "4";
        }else{
            //> 5 M
            echo $d['persen1'].'% x '.number_format($d['maksvalue1'] * 1000000).' = '.number_format(($d['maksvalue1'] * 1000000) * ($d['persen1']/100));
            ...
            $pph21thr = ($d['maksvalue1'] * 1000000) * ($d['persen1']/100) + (($d['maksvalue2']-$d['maksvalue1']) * 1000000) * ($d['persen2']/100) + (($d['maksvalue3']-$d['maksvalue2']) * 1000000) * ($d['persen3']/100) + (($d['maksvalue4']-$d['maksvalue3']) * 1000000) * ($d['persen4']/100) + ($pkp-($d['maksvalue4'] * 1000000)) * ($d['persen5']/100);
            // echo "5";
        }
    }

    echo "Tarif PPH21 THR = ".number_format($pph21thr);
    echo "<br>";
    echo "Tarif PPH21 Bulanan = ".number_format($pph21bulan)." + ( ".number_format($pph21thr)." - ".number_format($pph21)." )";
    echo "<br>";
    echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; = ".number_format($pph21bulan)." + ".number_format($pph21thr-$pph21);
    echo "<br>";
    echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; = ".number_format($pph21bulan+($pph21thr-$pph21));
}
?>