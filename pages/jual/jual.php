    ...
    //    var_dump($sql);
        ...
        foreach($data1 as $line) {
			...
			if(in_array($_SESSION['user']['access'], $allowDelete))
				$delete = '<a onclick="javascript:link_ajax(\''.BASE_URL.'pages/jual/jual.php?action=delete&id='.$line['id_trans'].'\',\'table_jual\')" href="javascript:;">BATAL</a>';
			else
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $("#table_jual").jqGrid({
            ...
            colNames:['ID','Kode','Customer','Tanggal Transaksi','Qty','Faktur','Ongkos Kuli','Total Faktur','Tunai','Bank','Piutang','Lihat','Batal'],
            colModel:[
