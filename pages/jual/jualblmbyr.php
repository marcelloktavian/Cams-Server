        ...
        foreach($data1 as $line) {
			...
			if(in_array($_SESSION['user']['access'], $allowEdit))
				//if($line['is_start'] == 0) {
					...
					$edit = '<a onclick="window.open(\''.BASE_URL.'pages/piutang/piutang_detail_lunasi.php?ids='.$line['id_trans'].'\',\'table_jual_blmbyr\')" href="javascript:;">Bayar</a>';
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $("#table_jual_blmbyr").jqGrid({
            ...
            rownumbers: true,
            sortorder: "asc",
            caption:"Data Penjualan Belum Lunas",
