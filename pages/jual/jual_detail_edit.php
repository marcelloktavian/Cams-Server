...
<table width='100%' cellspacing='0' cellpadding='0'>
    <tr>
     ...
     <tr>
        ...
        <td><input type='text' class='inputform' name='nama' id='nama' placeholder='Autosuggest Nama Pelanggan'  />
...
<tr>
<td>
<p align='center'><input name='print' type='image' src='../../assets/images/cetak2.png' value='Cetak' id='print' onClick='cetak()' /></p>
</td>
<td>
...
function cetak(){
	...
	{	
	hitungrow() ;
	//document.form2.action="jual_simpan.php?id_trans=<?=$_GET['ids']?>";
	document.form2.action="jual_nota.php?id_trans=<?=$_GET['ids']?>";
...
$sql1 = mysql_query("select a.id_detail,a.id_barang, b.nm_barang, a.qty, a.harga, (a.qty * a.harga) as subtotal from trjual_detail a, barang b where a.id_barang=b.id_barang and a.id_trans = '".$_GET['ids']."'");
$i=1;
