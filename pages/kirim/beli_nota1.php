...
<form id="form2" name="form2" action="" method="post"  onSubmit="return validasi(this)">
  ...
  <table width="100%" border="0" align="center">
    <tr>
      ...
      <td width="30%" class="style9"><div align="center" class="style99"><strong>FAKTUR PENGIRIMAN BARANG</strong></div></td>
  ...
  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
	...
	$sq2 = mysql_query("select a.id_detail,a.id_barang, b.nm_barang, a.qty, a.harga, (a.qty * a.harga) as subtotal from trbeli_detail a, barang b where a.id_barang=b.id_barang and a.id_trans ='".$_GET['id_trans']."'");
	$i=1;
	$nomer=0;
  ...
  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr>
      <td height="27" colspan="3"><p><span class="style20">Ketentuan </span> :<br />
          ...
          <span class="style20">2. Kami tidak bertanggung jawab atas barang pembelian yang tidak diambil dalam waktu 2 hari sejak tanggal pelunasan.</span><br />
