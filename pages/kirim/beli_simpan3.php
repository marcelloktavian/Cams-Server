...
include("../../include/koneksi.php");
	...
	//--- simpan master ---------------------------
	mysql_query("insert into trbeli(id_trans,kode,tgl_trans,id_supplier,totalfaktur,totalqty,id_user)values('".$id_pkb."','".$kode."',NOW(),'".$id_supplier."','".$totalfaktur."','".$totalqty."','".$id_user."')") or die (mysql_error());
	//---akhir simpan master----------------------
	}
