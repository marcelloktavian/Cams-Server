...
<form id="form2" name="form2" action="" method="post"  onSubmit="return validasi(this)">
  ...
  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr>
      ...
      <td width="39%" class="style21"><div align="center">Nama Barang</div></td>
      <!--<td width="9%" class="style21"><div align="right">No.Barang</div></td>-->
      <td width="9%" class="style21"><div align="right">Satuan</div></td>
	...
	$sq2 = mysql_query("select a.id_detail,a.id_barang, b.nm_barang, a.qty,b.kode_brg,a.harga, (a.qty * a.harga) as subtotal from trbeli_detail a, barang b where a.id_barang=b.id_barang and a.id_trans ='".$_GET['id_trans']."' order by a.qty asc,b.kode_brg + 0 asc");
	$i=1;
	$nomer=0;
