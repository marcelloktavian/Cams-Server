...
include("../../include/koneksi.php");
	...
	//--- simpan master -----------------------------
	mysql_query("insert into trbeli(id_trans,kode,tgl_trans,id_supplier,totalfaktur,faktur_murni,piutang,totalqty,id_user)values('".$id_pkb."','".$kode."','".$tgl."','".$id_supplier."','".$totalfaktur."','".$totalfaktur."','".$piutang."','".$totalqty."','".$id_user."')") or die (mysql_error());
	//---akhir simpan master----------------------
	...
	//-update detail------------------------
		...
		//update master------------------------------
		mysql_query("update trbeli set kode='".$kode."',faktur_murni='".$totalfaktur."',totalfaktur='".$totalfaktur."',piutang='".$totalfaktur."',tgl_trans='".$tgl."', totalqty='".$totalqty."', id_supplier='".$_POST['id_supplier']."' where id_trans='".$_GET['id_trans']."'") or die (mysql_error());
