...
<form id="form2" name="form2" action="" method="post"  onSubmit="return validasi(this)">
  ...
  <table width="100%" border="0" align="center">
    <tr>
      ...
      <td width="30%" class="style9"><div align="center" class="style99"><strong>SURAT JALAN</strong></div></td>
  ...
  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr>
      ...
      <td width="50%" class="style21"><div align="left">No.Barang</div></td>
      <!--
	  <td width="13%" class="style21">No.Barang</td>
      <td width="35%" class="style21"><div align="center">Nama Barang</div></td>
      <td width="30%" class="style21"><div align="center">Jenis Barang</div></td>
      <td width="10%" class="style21"><div align="center">Satuan</div></td>
	  -->
	  <td width="10%" class="style21"><div align="right">Jumlah(pcs)</div></td>
    </tr>
    <tr>
      <td colspan="6" class="style16"><hr /></td>
    </tr>
    <?
	$sql_data = "select a.id_detail,a.id_barang, b.nm_barang,j.nm_jenis, a.qty,b.kode_brg,a.harga, (a.qty * a.harga) as subtotal from trbeli_detail a left join barang b on b.id_barang = a.id_barang left join jenis_barang j on j.id = a.id_jenis where a.id_trans ='".$_GET['id_trans']."' order by a.qty asc,b.kode_brg + 0 asc";	
	//$sql_data = "select a.id_detail,a.id_barang, b.nm_barang,j.nm_barang as jenis, a.qty,b.kode_brg,a.harga, (a.qty * a.harga) as subtotal from trbeli_detail a, barang b where a.id_barang=b.id_barang and a.id_trans ='".$_GET['id_trans']."' left join jenis_barang j on j.id = a.id_jenis order by a.qty asc,b.kode_brg + 0 asc";
    ...
    echo "<td class='style9'><div align='center'>";
    echo $rs2['kode_brg'].'&nbsp;&nbsp';
    echo "</div></td>";
  ...
  ?>
    <tr>
	  ...
	  <!--
      <td class="style9"><div align="center"><?=$rs2['kode_brg'];?></div></td>
	  <td class="style9"><div align="center"><?=$rs2['nm_barang'];?></div></td>     
  ...
  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr>
      <td width="75%" height="27"><table width="99%" border="0">
          <tr>
            <td width="14%" class="style19">&nbsp; </td>
            <td width="2%"><div align="center">&nbsp;</div></td>
            <td width="84%"><div class="style11" id="terbilang"></div></td>
          </tr>
      </table></td>
      <td width="15%" class="style9"><div align="right"><strong>Grand Total(pcs)</strong></div></td>
