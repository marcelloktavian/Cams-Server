...
include("../../include/koneksi.php");
	...
	//-update detail------------------------
		...
		//update master------------------------------
		mysql_query("update trbeli set faktur_murni='".$totalfaktur."',totalfaktur='".$totalfaktur."',piutang='".$totalfaktur."',tgl_trans='".$tgl."', totalqty='".$totalqty."', id_supplier='".$_POST['id_supplier']."' where id_trans='".$_GET['id_trans']."'") or die (mysql_error());
