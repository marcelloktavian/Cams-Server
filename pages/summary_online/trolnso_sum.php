...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $("#table_jualsm").jqGrid({
            ...
            colNames:['ID','Code','Dropshipper','Oln.Date','Post.Date','Qty','Value','Exp.Fee','Total Value','Cash','Transfer','Receivables','Payment','Receiver','Expedition','Exp_code','Inv.','Print'],
            colModel:[
