...
<form id="form2" name="form2" action="" method="post"  onSubmit="return validasi(this)">
  ...
  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
      <th width="25%" class="style_title_left"><div align="center">Dropshipper</div></td>
  ...
  ?>
	   ...
	   <tr>
            <td class="style_footer" colspan="6"><div align="right">Nett Faktur(Faktur-Disc) :</div></td>
            <td class="style_footer"><div align="right"><?=number_format($nett_faktur);?></div></td>
       </tr>
	   <tr>
            <td class="style_footer" colspan="6"><div align="right">DPP:</div></td>
            <td class="style_footer"><div align="right"><?=number_format($dpp);?></div></td>
       </tr>
	   <tr>
            <td class="style_footer" colspan="6"><div align="right">PPN:</div></td>
