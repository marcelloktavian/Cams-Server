...
$filter_title="";
	...
	*/
	...
	$sql_detail = "SELECT dt.id_trans,SUBSTRING(dt.id_trans,8,5) AS alias_id,m.tgl_trans, m.ref_kode AS id_web,d.nama AS dropshipper,dt.namabrg,dt.jumlah_beli,dt.size,m.nama AS pembeli,e.nama AS expedition,m.state,i.id as id_kirim,m.stkirim FROM olnsodetail dt
