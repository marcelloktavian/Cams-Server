...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr>
      <td height="123" valign="top"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td width="100%" class="style_tgl" colspan="7"><div id='totalqty'>Dari: <?= $tglstart;?>&nbsp;-&nbsp;<?= $tglend ?>&nbsp;&nbsp; Total Product: 
            </div></td>           
		  </tr>
  ...
  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
	  ...
	  <th width="4%" class="style_title"><div align="center">31</div></td>
	  <th width="4%" class="style_title"><div align="center">32</div></td>
	  <th width="4%" class="style_title"><div align="center">33</div></td>
	  <th width="4%" class="style_title"><div align="center">34</div></td>
	  <th width="4%" class="style_title"><div align="center">35</div></td>
      <th width="4%" class="style_title"><div align="center">36</div></td>
      <th width="4%" class="style_title"><div align="center">37</div></td>
      <th width="4%" class="style_title"><div align="center">38</div></td>
      <th width="4%" class="style_title"><div align="center">39</div></td>
      <th width="4%" class="style_title"><div align="center">40</div></td>
      <th width="4%" class="style_title"><div align="center">41</div></td>
      <th width="4%" class="style_title"><div align="center">42</div></td>
      <th width="4%" class="style_title"><div align="center">43</div></td>
      <th width="4%" class="style_title"><div align="center">44</div></td>
      <th width="4%" class="style_title"><div align="center">45</div></td>
      <th width="4%" class="style_title"><div align="center">46</div></td>
  ...
  ?>
    ...
    <?
		...
		IFNULL(SUM(IF((det.size) = '46', det.jumlah_beli, 0)),0) ) AS subtotal FROM olnso m LEFT JOIN olnsodetail det ON det.id_trans=m.id_trans WHERE det.namabrg LIKE '".$rs2['nama']."%' ".$where_detail;

		$sql2= "SELECT IFNULL(SUM(IF((det.size) = '', det.jumlah_beli, 0)),0) as subtotal FROM olnso m LEFT JOIN olnsodetail det ON det.id_trans=m.id_trans WHERE det.namabrg LIKE '".$rs2['nama']."%' ".$where_detail;
