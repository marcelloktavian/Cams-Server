...
function generateProdukJasa(index){
  var idx = document.createElement("input");
  idx.type="text"; idx.name="produk_jasa"+index; idx.id="produk_jasa"+index; idx.readOnly = "readonly"; idx.size="42";
  return idx;
}

function generateKategori(index){
  var idx = document.createElement("input");
  idx.type="text"; idx.name="kategori"+index; idx.id="kategori"+index; idx.readOnly = "readonly";
  return idx;
}

function generateQuotation(index){
  var idx = document.createElement("input");
  idx.type="text"; idx.name="tgl_quotation"+index; idx.id="tgl_quotation"+index; idx.readOnly = "readonly";
  return idx;
}

function generateSatuan(index){
  var idx = document.createElement("input");
  idx.type="text"; idx.name="satuan"+index; idx.id="satuan"+index; idx.readOnly = "readonly";
  return idx;
}

function generateHarga(index){
  var idx = document.createElement("input");
  idx.type="text"; idx.name="harga"+index; idx.id="harga"+index; idx.size="20"; idx.readOnly="readonly"; idx.class="";
  return idx;
}
