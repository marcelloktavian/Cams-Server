...
<form id="form2" name="form2" action="" method="post"  onSubmit="return validasi(this)">
  ...
  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
	...
	$sq2 = mysql_query("select b.namaperusahaan,a.id_trans,a.kode, date_format(a.tgl_trans,'%d-%m-%Y') as tgl_trans, a.totalqty,a.faktur, a.totalfaktur,b.id_cust, a.tunai,a.transfer,a.deposit,a.piutang,a.biaya from trjual a left join tblpelanggan b on b.id = a.id_customer ".$where." order by a.id_trans asc");
  ...
  ?>
    <tr>
      ...
      <td class="style9"><div align="right">
       ...
       <td class="style9"><div align="right">
	   <!-- deposit dimasukan ke dalam kolom transfer -->
          <?=number_format($rs2['transfer']+$rs2['deposit'],0);?>
      </div></td>
      <td class="style9"><div align="right">
	...
	$grand_transfer+=$rs2['transfer']+$rs2['deposit'];
