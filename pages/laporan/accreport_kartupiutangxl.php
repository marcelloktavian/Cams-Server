...
header("Content-Disposition: attachment; filename=kartupiutangdetail.xls");
?>
...
<form id="form2" name="form2" action="" method="post"  onSubmit="return validasi(this)">
    ...
    <tr>
      <td height="123" valign="top"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
			...
			KARTU PIUTANG DETAIL</strong></td>
          </tr>
          <tr>
  ...
  <table width="100%" id="tbd" border="0" align="center" cellpadding="0" cellspacing="0">
	...
	/*
	$sql_union="
	Select 'JUAL' as trans,'' as id_transjual,tgl_trans,date_format(tgl_trans,'%d-%m-%Y')as tgl_edit,id_customer, id_trans,kode,faktur,biaya,tunai,transfer,totalfaktur,(totalfaktur-piutang) as bayar_faktur,piutang as piutang_faktur,'' as piutang_tunai ,'' as piutang_transfer,'' as piutang_bayar from trjual ".$where."   
    union all
	Select 'JUALBAYAR' as trans,'' as id_transjual,tgl_trans,date_format(tgl_trans,'%d-%m-%Y')as tgl_edit,id_customer,id_trans,kode,faktur,biaya,tunai,transfer,totalfaktur,(totalfaktur-piutang) as bayar_faktur,piutang as piutang_faktur,'' as piutang_tunai ,'' as piutang_transfer,'' as piutang_bayar from trjual ".$where." and (tunai+transfer)>0)
    union all
