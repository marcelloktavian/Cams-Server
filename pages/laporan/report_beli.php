...
<?php
	...
	if(isset($_GET['action']) && strtolower($_GET['action']) == 'preview') {
		...
		//$p->customSql("SELECT b.id_trans,b.id_supplier,b.tgl_trans, b.totalqty,b.totalfaktur FROM trbeli b WHERE b.faktur=0 and (b.tgl_trans between '$start' and '$end')");
		$p->customSql("SELECT b.id_trans,b.id_supplier,b.tgl_trans, b.totalqty,b.totalfaktur FROM trbeli b WHERE (b.tgl_trans between '$start' and '$end')");
		...
		*/
		...
		$p->width('id_trans','100');
		$p->align('id_supplier','left');
		$p->width('id_supplier','60');
		$p->align('tgl_trans','center');
		$p->width('tgl_trans','150');
...
<div class="ui-widget ui-form">
    ...
    <div class="ui-widget-content ui-corner-bottom">
        <form id="report_project_form" method="" action="" class="ui-helper-clearfix">
            ...
            <div class="ui-corner-all form-control">
            	<button onclick="javascript:window_open('<?php echo BASE_URL ?>pages/laporan/report_beli.php?action=preview&start='+$('#startdate').val()+'&end='+$('#enddate').val())" class="btn" type="button">Preview</button>
            </div>
       	</form>
   	</div>
</div>
