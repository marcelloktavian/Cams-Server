...
header("Content-Disposition: attachment; filename=lappiutang.xls");
?>
...
<form id="form2" name="form2" action="" method="post"  onSubmit="return validasi(this)">
  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr>
      <td height="123" valign="top"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td width="50%" class="style99" colspan="6"><strong>LAPORAN TRANSAKSI PEMBAYARAN PIUTANG TOKO</strong></td>
  ...
  ?>
	...
	<tr>
	<td class="style9" colspan="9"><div align="right">Total</div></td>
	</td>
	<td class="style9"><div align="right">
