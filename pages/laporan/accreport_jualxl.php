...
<form id="form2" name="form2" action="" method="post"  onSubmit="return validasi(this)">
  ...
  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
	...
	a.tunai,a.transfer,a.deposit,a.piutang,a.biaya,(a.totalfaktur-a.piutang) as bayar from trjual a left join tblpelanggan b on b.id = a.id_customer ".$where." order by a.tgl_trans asc");
//	"2017-06-15", "%M %d %Y"
