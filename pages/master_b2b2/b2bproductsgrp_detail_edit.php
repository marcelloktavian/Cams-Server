...
<table width='100%'>
<tr>
    <td class='fontjudul'>EDIT B2B PRODUCTS CATEGORY DETAIL</td>
</tr>
</table>
...
<table width='100%' cellspacing='0' cellpadding='0'>
     ...
     <tr>
		...
		<input type='hidden' class='inputform' name='totalqty' id='totalqty' value='$totalqty'/>
		
		<td class='fonttext'>Nama Group</td>
		<td><input type='text' class='inputform' name='nama' id='nama' 	placeholder='Nama Product Group' value='$nama' /> </td>
     </tr>
	 <tr height='1'>
     <td colspan='4'></td>
     </tr>
...
<?php 
	$sql_detail="SELECT pd.id,pd.id_product,pd.size,c.nama AS produk FROM mst_b2bproductsgrp_detail pd LEFT JOIN mst_b2bproducts c ON pd.id_product=c.id  WHERE pd.id_productsgrp ='".$_GET['ids']."' ORDER BY c.id ASC";
