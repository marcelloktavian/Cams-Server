...
include("../../include/koneksi.php");    
	...
	*/
	...
	//--- simpan master -----------------------------
	$sql_master="";
	$sql_master="insert into mst_b2bcustomer(nama,alamat,no_telp,hp,id_address,due,acc_info,contact,note,totalqty,user,lastmodified)values('".$nama."','".$alamat."','".$telp."','".$hp."','".$id_address."','".$due."','".$acc_info."','".$contact."','".$note."','".$totalqty."','".$id_user."',NOW())";
	...
	//-update detail------------------------
		...
		//update master------------------------------
		$sql_master_up="update mst_b2bcustomer set nama='".$nama."',alamat='".$alamat."',no_telp='".$telp."',hp='".$hp."',id_address='".$id_address."',due='".$due."',acc_info='".$acc_info."',contact='".$contact."',note='".$note."',totalqty='".$totalqty."',user='".$id_user."',lastmodified=now() where id= '".$_GET['id_trans']."'";
