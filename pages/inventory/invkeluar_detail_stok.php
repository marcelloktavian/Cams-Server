...
echo"<form id='form2' name='form2' action='' method='post'>
    <table width='100%'>
  	<tr>
		...
		<td class='fontjudul'> TOTAL QTY <input type='text' class='' name='totalqty' id='totalqty' style='text-align:right;font-size: 30px;background-color:white;height:40px;border:1px dotted #f30; border-radius:4px; -moz-border-radius:4px;' value='0' />
  ...
  $id = $_GET['ids'];
	...
	$i=1;
		...
		?>
			...
			document.getElementById('NamaBrg'+<?=$i;?>+'').value = '<?=$rs1['nama'];?>';
