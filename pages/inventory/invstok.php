...
if(isset($_GET['action']) && strtolower($_GET['action']) == 'json') {
	...
	$sord  = $_GET['sord'];
        ...
        */
        ...
        //$where = " WHERE TRUE ";
        $where = " WHERE TRUE AND p.deleted=0 AND p.oln_product_id is not null AND p.oln_product_id <> '' AND p.oln_product_id <> '0'  ";
		/*
		if($startdate != null){
		...
		*/
		...
		foreach($data1 as $line) {
			if ($statusToko == 'Tutup') {
                $tambah = '<a style="text-decoration:none" onclick="javascript:custom_alert(\'Maaf, Toko Sudah Tutup\')" href="javascript:;">+</a>';
                $kurang = '<a style="text-decoration:none" onclick="javascript:custom_alert(\'Maaf, Toko Sudah Tutup\')" href="javascript:;">-</a>';
                $edit = '<a onclick="javascript:custom_alert(\'Maaf, Toko Sudah Tutup\')" href="javascript:;">UPDATED</a>';
            } else {
			...
			if ($allow_post) {
				$tambah = '<a style="text-decoration:none" onclick="window.open(\''.BASE_URL.'pages/inventory/invmasuk_detail_stok.php?ids='.$line['id'].'\',\'table_inventory\')" href="javascript:;">+</a>';
				$kurang = '<a style="text-decoration:none" onclick="window.open(\''.BASE_URL.'pages/inventory/invkeluar_detail_stok.php?ids='.$line['id'].'\',\'table_inventory\')" href="javascript:;">-</a>';
			}else{
				$kurang = '<a onclick="javascript:custom_alert(\'Tidak Boleh Kurang Stok\')" href="javascript:;">-</a>';
				$tambah = '<a onclick="javascript:custom_alert(\'Tidak Boleh Tambah Stok\')" href="javascript:;">+</a>';
			}
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		$("#table_inventory").jqGrid({
			...
			{name:'minus',index:'minus', align:'center', width:10,searchoptions: {sopt:['cn']}},         
			{name:'stok',index:'stok', align:'center', width:40,searchoptions: {sopt:['cn']}},
			{name:'tambah',index:'tambah', align:'center', width:10,searchoptions: {sopt:['cn']}},
