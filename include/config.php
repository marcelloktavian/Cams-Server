...
// define("departemen", 21);
// define("jabatan", 22);
// define("pendapatan", 23);
// define("potongan", 24);
// define("karyawan", 25);

// define("penggajian", 27);
// define("transpendapatan", 28);
// define("transpotongan", 29);

// define("Address", 31);
// define("Category", 32);
// define("Colour", 33);
// define("Keranjang", 34);
// define("Dropshipper", 35);
// define("ExpeditionCategory",36);
// define("Expedition", 37);
// define("Products", 38);
// define("ProductsComposition", 39);

// define("ImportCAMOU", 41);
// define("PreSALES", 42);
// define("ImportCredit", 43);
// define("PreSALESCredit", 44);

// define("DropshipperDeposit", 46);
// define("DepositTransaction", 47);
// define("OnlineSales", 48);
// define("OnlineCredit",49);
// define("PendingOrder", 50);
// define("CancelOrder", 51);
// define("OnlineDelivery",52);
// define("OnlineBackDate",53);
// define("ArchiveOrder", 54);
// define("OnlineReturn", 55);
// define("ReturnConfirmed", 56);
...
// define("ImportCustomerProduct", 71);

// define("CompositionProducts", 73);
// define("B2BProducts", 74);
// define("B2BProductsGroup", 75);
// define("B2BCustomer", 76);
// define("B2BExpedition",77);
// define("B2BSalesman", 78);

// define("AddSalesB2B", 80);
// define("SalesB2B", 81);
// define("ConfirmedSales", 82);
// define("DeliveryOrderB2B", 83);
// define("ArchiveOrderB2B", 84);

// define("SummaryDeliveryB2B", 86);
// define("stb2bdo", 87);
// define("b2bsorpt", 88);
// define("b2bcomp", 89);

// define("MUTASIMASUK", 91);
// define("MUTASIKELUAR", 92);
// define("INVENTORY", 93);

// define("MUTASIMASUK_COMP", 95);
// define("MUTASIKELUAR_COMP", 96);
// define("INVENTORY_COMP", 97);

// define("DataUser", 99);
// define("UserGroup", 100);
// define("GroupAkses", 101);
// define("statusToko", 102);
...
define("po", 95);
define("poapproval", 96);
define("archivepo", 97);

define("MUTASIMASUK", 99);
define("MUTASIKELUAR", 100);
define("INVENTORY", 101);

define("MUTASIMASUK_COMP", 103);
define("MUTASIKELUAR_COMP", 104);
define("INVENTORY_COMP", 105);

define("DataUser", 107);
define("UserGroup", 108);
define("GroupAkses", 109);
define("statusToko", 110);
