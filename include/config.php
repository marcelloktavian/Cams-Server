...
// define("DeliveryOrderB2B", 93);
// define("trb2bpiutangPembayaran", 94);
// define("trb2bkomisi", 95);
// define("trb2breturn", 96);
// define("arb2b", 97);

// define("SummaryDeliveryB2B", 99);
// define("stb2bdo", 100);
// define("b2bsorpt", 101);
// define("ArchiveOrderB2B", 102);
// define("b2bcomp", 103);
// define("b2bretur", 104);
// define("b2bcompretur", 105);

// define("pemohonpo", 107);
// define("supplier", 108);
// define("produkpo", 109);

// define("po", 111);
// define("poapproval", 112);
// define("archivepo", 113);

// define("MUTASIMASUK", 115);
// define("MUTASIKELUAR", 116);
// define("INVENTORY", 117);

// define("MUTASIMASUK_COMP", 119);
// define("MUTASIKELUAR_COMP", 120);
// define("INVENTORY_COMP", 121);

// define("DataUser", 123);
// define("UserGroup", 124);
// define("GroupAkses", 125);
// define("statusToko", 126);
...
define("olnreturn", 81);
define("OnlineBackDate", 82);

define("ImportCustomerProduct", 84);

define("CompositionProducts", 86);
define("B2BProducts", 87);
define("B2BProductsGroup", 88);
define("B2BCustomer", 89);
define("B2BExpedition", 90);
define("B2BSalesman", 91);

define("AddSalesB2B", 93);
define("SalesB2B", 94);
define("ConfirmedSales", 95);
define("DeliveryOrderB2B", 96);
define("trb2bpiutangPembayaran", 97);
define("trb2bkomisi", 98);
define("trb2breturn", 99);
define("arb2b", 100);

define("SummaryDeliveryB2B", 102);
define("stb2bdo", 103);
define("b2bsorpt", 104);
define("ArchiveOrderB2B", 105);
define("b2bcomp", 106);
define("b2bretur", 107);
define("b2bcompretur", 108);

define("pemohonpo", 110);
define("supplier", 111);
define("produkpo", 112);

define("po", 114);
define("poapproval", 115);
define("archivepo", 116);

define("MUTASIMASUK", 118);
define("MUTASIKELUAR", 119);
define("INVENTORY", 120);

define("MUTASIMASUK_COMP", 122);
define("MUTASIKELUAR_COMP", 123);
define("INVENTORY_COMP", 124);

define("DataUser", 126);
define("UserGroup", 127);
define("GroupAkses", 128);
define("statusToko", 129);
